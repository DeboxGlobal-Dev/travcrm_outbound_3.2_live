...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Delete" onclick="alertspopupopen('action=corportatedelete&name=Calls','600px','auto');" />
	<?php } ?>
	</div>
...
$rs2=GetPageRecord($select2,_CALLS_MASTER_,$where2); 
...
<input name="action" type="hidden" value="callsdelete" id="action" />
