...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tbody>
        <tr>
            ...
            <h3 class="cms_title">Visa Report</h3>
                ...
                <table width="100%" border="1" cellpadding="5" cellspacing="0" id="example" style="margin-top: 40px;">
                  ...
                  $q = GetPageRecord('*','finalQuoteVisa','quotationId!="" and queryId!="" order by id desc');
...
dom: 'frtilpB',
buttons: [
{extend: 'copyHtml5', title: 'Visa Report'},
{extend: 'excelHtml5', title: 'Visa Report'},
{extend: 'pdfHtml5', title: 'Visa Report',
