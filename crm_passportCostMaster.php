...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <td width="7%">
	...
	<input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Deactivate" onclick="masters_alertspopupopen('action=mastersdelete&name=passportCost','600px','auto');" />
	<?php } ?>
	</div>
...
<input name="action" id="action" type="hidden" value="deletePassportCost" />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
   ...
   <tr>
    ...
    <label for="checkAll"><span></span>&nbsp;</label></th> 
     <th align="left" class="header" >Passport Name </th>
     <th align="left" class="header" >Passport Type </th>
...
$rs=GetRecordList($select,'passportCostMaster',$where,$limit,$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2]; 
...
//} ?></td> -->
<td><?php 
$rs1=GetPageRecord('name,id','passportTypeMaster',' id="'.$resultlists['passportType'].'" and status=1 and deletestatus=0 '); 
$resultlists1 = mysqli_fetch_assoc($rs1);
echo $resultlists1['name'];
?></td>
<td> <a href="showpage.crm?module=<?php echo $_REQUEST['module'];?>&amp;view=yes&amp;passportId=<?php echo encode($resultlists['id']);?>">
