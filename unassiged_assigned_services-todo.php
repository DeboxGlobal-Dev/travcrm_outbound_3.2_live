...
<div style="overflow:hidden; margin-top:20px;">
	 <table border="0" align="right" cellpadding="5" cellspacing="0">
	  	<tbody>
	  		<tr>
		    	<td> 
				     <input type="button" class="whitembutton" value="Close" onclick="alertspopupopenClose();">
				</td>
		  	</tr>
		</tbody>
	</table>
...
<script type="text/javascript">
	function updateQuothotel(quotationId,QuotId,serviceId,type) {
		var supplierId = $('#supplier'+QuotId).val();
		 $("#updatefinalquotation").load('updatefinalquotsupplier-todo.php?queryId=<?php echo $_REQUEST['queryId']; ?>&QuotId='+QuotId+'&type='+type+'&supplierId='+supplierId+'&serviceId='+serviceId+'&quotationId='+quotationId);
		 if(supplierId!=''){
