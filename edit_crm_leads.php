...
deleteRecord(_LEAD_MASTER_,$wheredel);

$dateAdded=time();
$namevalue ='deletestatus=1,addedBy="'.$_SESSION['userid'].'",dateAdded="'.$dateAdded.'"';  
$lastqueryidmain= addlistinggetlastid(_LEAD_MASTER_,$namevalue);
...
$select1='*';  
$where1='id='.$id.''; 
$rs1=GetPageRecord($select1,_LEAD_MASTER_,$where1); 
...
<div class="addeditpagebox">
  <input name="action" type="hidden" id="action" value="<?php if($_GET['id']!=''){ echo 'editleads';} else { echo 'addleads'; } ?>" />
...
<?php } ?>
 ...
 <option value="1">Low</option>  
	...
	<div class="griddiv"><label>
	<div class="gridlable">Lead  Subject <span class="redmind"></span></div>
  ...
  <tr>
	...
	<div  style="display:none; margin:10px 0px 20px;border: 1px #e0e0e0 solid;">
