...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <td width="7%">
	...
	<input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Deactivate" onclick="masters_alertspopupopen('action=mastersdelete&name=passportType','600px','auto');" />
	<?php } ?>
	</div>
...
<input name="action" id="action" type="hidden" value="deletePassportType" />
...
$rs=GetRecordList($select,'passportTypeMaster',$where,$limit,$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2]; 
