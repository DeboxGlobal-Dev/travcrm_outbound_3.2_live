...
$DataQuery .= " MyTable.ServiceDescription, MyTable.ServiceDescription_1, MyTable.serviceImage,MyTable.voucherURL, ";
...
// $supplierStatusId = $DayWiseData['supplierStatusId'];
...
// $voucher =$fullurl.'showpage.crm?module=ClientVoucher&qid='.encode($DayWiseData['QuotationID']).'&queryId='.encode($DayWiseData['QueryID']);
}
if ($sNooo>0){
?>
,{
...
<?php } ?>
		...
		"StartTime": "<?php if($DayWiseData['StartTime']!=''){ echo date('h:i:s A',strtotime($DayWiseData['StartTime'])); }else{ echo '...'; }?>",
		"EndTime": "<?php if($DayWiseData['EndTime'] !='' ){ echo date('h:i:s A',strtotime($DayWiseData['EndTime'])); }else{ echo '...'; } ?>",
