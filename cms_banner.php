          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
            ...
            <tbody>
              <?php
                ...
                $where='where type="banner" order by id desc';
                $page=$_GET['page'];
                ...
                while($resultlists=mysqli_fetch_array($rs[0])){
                  ...
                  <tr>
                      ...
                      <td width="10%" align="center">
                        ...
                        <a href="showpage.crm?module=cms&page=banner&amp;status=0&amp;id=<?php echo $resultlists['id']; ?>"> <img src="images/unlock.png" width="30" border="0" /> </a>
                        <?php } else { ?>
                        <a href="showpage.crm?module=cms&page=banner&amp;status=1&amp;id=<?php echo $resultlists['id']; ?>"> <img src="images/lock.png" /> </a>
                        <?php } ?>
                      </td>
                      <td width="10%" align="center">
                      ...
                      <td width="10%" align="center">
                        <a href="?module=cms&amp;page=banner&amp;id=<?php echo $resultlists['id']; ?>&amp;action=del" onclick="return cmd_del()"> 
