      ...
      <td align="right">
        <table border="0" cellpadding="0" cellspacing="0">
          <tbody><tr>
            <td></td>
            <!--<td>-->
            <!--  <input name="addnewuserbtn2" type="button" class="bluembutton submitbtn" id="addnewuserbtn2" value="Send Vouchers" onclick="setupbox('showpage.crm?module=query&view=yes&id=<?php echo encode($result['queryId']); ?>&allvoucher=<?php echo trim($result['id']).'_'.trim($_REQUEST['module']).'_1'; ?>');">-->
            <!--</td>-->
...
<div style="padding:20px;"> 
  ...
  <script>
  $('#loadcreateitinerary').load('loadcreatevoucher_supplier.php?quotationId=<?php echo decode($_REQUEST['qid']); ?>&module=<?php echo clean($_GET['module']); ?>');
  </script>
</div>              
