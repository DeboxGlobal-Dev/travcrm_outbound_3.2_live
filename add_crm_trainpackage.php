...
if($_REQUEST['id']==''){
	...
	$dateAdded=time();
	$namevalue ='deletestatus=1,moduleType=6,addedBy="'.$_SESSION['userid'].'",dateAdded="'.$dateAdded.'"';
  ...
  <tr>
	  ...
	  <tr>
		<td colspan="2">
 		...
 		<select name="queryType" id="queryType"  class="gridfield"  onchange="gitcodefun();">
			<option value="6">Train&nbsp;Package</option>
 		</select>
 		</label></div>
		</td>
	  </tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" style=" ">
	  <tr>
		...
		<div class="gridlable">Train&nbsp;Package&nbsp;Name<span class="redmind"></span></div>

		<input name="subject" type="text" class="gridfield validate"  id="subject"  value="<?php echo $editsubject; ?>" displayname="Train Package Name" maxlength="250"  />
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" style=" ">
	  <tr>
		...
		<div class="gridlable">Train&nbsp;Package&nbsp;Code<span class="redmind"></span></div>

		<input name="FDCode" type="text" class="gridfield validate" id="FDCode" value="<?php echo $FDCode; ?>"  displayname="Train Package Code" maxlength="250" />
	...
	<div style="background-color:#f5f5f5; padding:10px; border:1px #ccc solid; cursor:pointer;" onclick="$('#showmorefield2').toggle();">Train&nbsp;Package&nbsp;Plan&nbsp;Itinerary</div>
...
changedatetr();
	...
	<input type="hidden" name="moduleType" id="moduleType" value="6" />
