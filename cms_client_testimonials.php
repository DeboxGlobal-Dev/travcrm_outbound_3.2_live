...
$id=$_REQUEST['id'];
	...
	header("location:?module=cms&page=client_testimonials&alt=2");	
}
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <?php } ?>
      ...
      <td align="right"><table border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <?php if($addpermission==1){ ?><td style="padding-right:20px;"><input name="addnewuserbtn" type="button" class="bluembutton" id="addnewuserbtn" value="+ Add New <?php echo $pageName; ?>" onclick="cms_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&page=<?php echo clean($_GET['page']); ?>','600px','auto');" /></td> <?php } ?>
        </tr>
  ...
  <div id="pagelisterouter" style="padding-left:30px;">
    <input name="action" id="action" type="hidden" value="cms_client_testimonials" />
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
          <thead>
            <tr>
              ...
              <th  align="left" class="header" >Star Rating</th>
        ...
        <?php
          ...
          $where='where type="client_testimonials" order by srn asc'; 
          $page=$_GET['page'];
          ...
          ?>
        <tr>
          <td width="8%" align="left"><?php echo ++$cnt;?> </td>
          ...
          <td width="10%" align="left"><?php echo $resultlists['home_text']; ?> </td>
          <td width="8%" align="left"><?php echo $resultlists['designation']; ?> </td>
          <td width="8%" align="left"><?php echo $resultlists['city']; ?> </td>
          ...
          <td width="14%" align="left"><?php if($resultlists['image1']!=''){ ?><img src="<?php echo $fullurl; ?><?php echo $resultlists['image1']; ?>" width="70" />   <?php }else{ }  ?>
          </td>
          <td width="10%" align="center">
            <?php if($resultlists['status']==1){ ?>
              <a href="showpage.crm?module=cms&page=client_testimonials&amp;status=0&amp;id=<?php echo $resultlists['id']; ?>"> <img src="images/unlock.png" width="30" border="0" /> </a>
            <?php } else { ?>
              <a href="showpage.crm?module=cms&page=client_testimonials&amp;status=1&amp;id=<?php echo $resultlists['id']; ?>"> <img src="images/lock.png" /> </a>
            <?php } ?>
            </td>
            <td width="9%" align="center">
              <div class="bluelink" onclick="cms_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&page=<?php echo clean($_GET['page']); ?>&id=<?php echo $resultlists['id']; ?>','800px','auto');" >
                <img src="images/edit_icon.png" alt="Edit" width="20"  border="0" /> </a>
              </div>
            </td>
            <td width="9%" align="center"><a href="?module=cms&amp;page=client_testimonials&amp;id=<?php echo $resultlists['id']; ?>&amp;action=del" onclick="return cmd_del()"> 
              <img src="images/dlt.png" alt="Delete" width="20"  border="0" /> </a>
            </td>
          </tr>
        <?php $no++; } ?>
      </tbody>
