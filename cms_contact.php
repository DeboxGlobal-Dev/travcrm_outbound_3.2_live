...
if($_REQUEST['edit']=="edit") { 
	...
	header("location:showpage.crm?module=cms&page=contact&alt=2");		
}
	...
	$activity_duration=clean($editresult['activity_duration']); 
	$email=clean($editresult['email']); 
	$detail6=clean($editresult['detail6']); 
	$description=stripslashes(($editresult['description'])); 
	$category=clean($editresult['category']);
	$shortdescription=stripslashes($editresult['shortdescription']);
	$detail1=clean($editresult['detail1']);
	$detail2=clean($editresult['detail2']);
	$detail3=clean($editresult['detail3']);
	$detail4=clean($editresult['detail4']);
	$detail5=strip(clean($editresult['detail5']));
?>
...
<!--   <tr>
  ...
  <tr>
	...
	<div class="griddiv">
		<label>
			<div class="gridlable">Phone Number (For Footer) <span class="redmind"></span></div>
	...
	<div class="griddiv">
	<label>
	<div class="gridlable" style="width: 100%!important;">Email ( Use comma for multiple email address like example@gmail.com,example@gmail.coms)<span class="redmind"></span></div>
	...
	<div class="griddiv">
		<label>
			<div class="gridlable">Office Address (For Website footer) <span class="redmind"></span></div>
	...
	<input name="detail2" type="text" id="detail2" value="<?php  echo $detail2; ?>"   class="gridfield validate"  autocomplete="off" />
	</label>
	</div>
	  <div class="griddiv">
	<label>
	<div class="gridlable">Instagram <span class="redmind"></span></div>
	<input name="detail3" type="text" id="detail3" value="<?php  echo $detail3; ?>"   class="gridfield validate"  autocomplete="off" />
	</label>
	</div>
<div class="griddiv">
	<label>
	<div class="gridlable">Twitter <span class="redmind"></span></div>
	<input name="detail4" type="text" id="detail4" value="<?php  echo $detail4; ?>"   class="gridfield validate"  autocomplete="off" />
	</label>
	</div>
		<div class="griddiv">
	<label>
	<div class="gridlable">LinkedIn <span class="redmind"></span></div>
	<input name="detail5" type="text" id="detail5" value="<?php  echo $detail5; ?>"   class="gridfield validate"  autocomplete="off" />
	</label>
	</div>
	</td>
    </tr>
