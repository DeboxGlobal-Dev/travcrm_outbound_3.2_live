...
<input name="action" id="action" type="hidden" value="deletevisasubdocument" />
...
$selectaa='name';   
$whereaa='id="'.$resultlists['docId'].'"'; 
$rsaa=GetPageRecord($selectaa,_VISA_DOCUMENT_MASTER_,$whereaa); 
$documenttype=mysqli_fetch_array($rsaa);  
