...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body style="background-color: #ffffff;">
      <div style="width:100%;">
         <div style="width:100%;float:left;display: block;min-height: 600px;background-image:url(loginpage/images/TRAVCRM-Outbound-Login-Screen-BG1.jpg);background-repeat:no-repeat;background-position: 0 0;background-size: 100% 100%;z-index: 999999999;overflow: visible;">&nbsp;</div>
         ...
         <div style=" width:40%; float:left; text-align:center; position :absolute; right: 0px; ">
