   ...
   <?php 
    ...
    border: 1px solid #f7f0f0;">
		   ...
		   <div class="text-boxes">
			  ...
			  <input type="text" class="form-control" placeholder="Enter Your Email Address" name="username" id="username" style="box-sizing: border-box;" value="<?php echo $userName_Cookie; ?>"> 
		   </div>
		   
		   <div class="text-boxes">
			  <label for="password"  style="font-weight: 500;">Password:</label>
			  <input type="password" class="form-control" placeholder="Enter Your Password" name="userpass" id="userpass"  style="box-sizing: border-box;" value="<?php echo $password_Cookie; ?>"> 
		   </div>
			...
			<div class="row" style="">
				...
				<div class="two-links" style="float: left;text-align: left;">
			  			<!-- <a onClick="" style="color:#5a5050;font-size: 11px;font-weight: 500;" > -->
						<input class="form-check-input" type="checkbox" <?php echo $checkbox_Cookie; ?> id="rememberMe" name="rememberMe" style="display: block;">
							<label class="form-check-label" for="gridCheck1" style="color:#5a5050;font-size: 11px;font-weight: 500;width: 200px;margin-left: 15%; margin-top: -12%;">
							Remember me
					</label>
				<!-- </a> -->
			  		</div>
					  
			  		<div class="two-links" style="float: left;text-align: right;">
		   ...
		   <div class="login-button" style="width: 100%; text-align: center; margin-top: 15px;">
			  <input type="button" name="submit" value="Login" onClick="login(2);" style="width: 100%;    background-color: #919191; cursor:pointer; text-align: center; padding: 10px; font-size: 12px; color: #fff; border: 0px solid; outline: 0px; border-radius: 2px;">
		   </div> 
   ...
   <img src="loginpage/images/Powered-by-De-Box.png" height="32" style="position: absolute;
    ...
    margin-left: 7px;" />
		...
		if($sectionBox=='3'){
			...
			<div class="login-button" style="width: 100%; text-align: center; margin-top: 15px;">
			  <input type="button" name="submit" value="Login" onClick="loginotp();" style="width: 100%;     background-color: #919191;cursor:pointer; text-align: center; padding: 10px; font-size: 12px; color: #fff; border: 0px solid; outline: 0px; border-radius: 2px;">
			</div>
...
<script> 
	...
	function login(id) {
	   ...
	   // first action 
            ...
            $('#lodingloadbox').html('<img src="loginpage/loadinglogin.gif" />');
            $('#lodingloadbox').load('lodingloadbox.php?username='+username+'&userpass='+userpass+'&rememberMe='+rememberMe);
	   }
	   else if(id==3){
	   		$('#lodingloadbox').html('<img src="loginpage/loadinglogin.gif" />');
