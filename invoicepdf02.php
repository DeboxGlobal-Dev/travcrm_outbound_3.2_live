...
<div style="color:#000000;font-family: 'Roboto', sans-serif!important"> 
	...
	<table width="100%" border="0" cellpadding="0" celspacing="0" style="font-size: 13px;border-collapse: collapse; border-bottom: 1px solid #ccc;">
		<tbody>
			<tr>
				<td align="left" valign="middle" height="65" width="30%">
				...
				<td width= "70%" align="left" style="font-size: 11px; ">
					<strong class="style3" ><?php if($invmData['invoiceType']=='1'){ echo 'TAX INVOICE'; } else { echo 'PROFORMA INVOICE'; } ?></strong>
					<br>
				    ...
				    <strong>&nbsp;Website: </strong>&nbsp;<?php echo $resultInvoiceSetting['website']; ?><br><br>
				</td>
			</tr>
		</tbody>
	</table> 
	<table  width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top: 8px;font-size:12px;border-collapse: collapse; border-bottom: 1px solid #ccc;">
		<tbody>
		<tr>
			<td width="60%">
				<strong>&nbsp;Bill To:&nbsp;&nbsp;</strong><br>
			</td>
			<td width="25%"><strong>&nbsp;Invoice No:</strong>&nbsp;<?php echo makeInvoiceId($invmData['id']); ?></strong></td>
		</tr>
		<tr>
			<td width="60%">
				<strong>&nbsp;<?php echo showClientTypeUserName($queryData['clientType'],$queryData['companyId']); ?></strong><br>
			</td>
			<td width="30%"><strong>&nbsp;Date:</strong>&nbsp;<?php echo date("j M Y", strtotime($invmData['invoicedate'])); ?></td>
		</tr>
		<tr>
			<td width="60%">
				<strong>&nbsp;Address:&nbsp;</strong><?php echo $resultCompany['address1'].' '.$resultCompany['pinCode'] ; ?><br>
			</td>
			<td><strong>&nbsp;Reference No:</strong>&nbsp;<?php echo $invmData['referNo']; ?></strong></td>
		</tr>
		<tr>	 
			<td width="60%">
				<strong>&nbsp;Email:&nbsp;</strong><?php echo $queryData['guest1email']; ?><br>
			</td>
			<td><strong>&nbsp;Tour Id:</strong>&nbsp;<?php if($invmData['fileNo']!=''){ echo $invmData['tourId']; } ?></strong></td>
		</tr>
    <tr>
       <td width="60%"><strong>&nbsp;Guest:</strong>&nbsp;<?php echo $invmData['guestName'];?></strong></td>
				<td><strong>&nbsp;Currency:</strong>&nbsp;<?php echo getCurrencyName($currencyId); ?></strong></td>
		...
		<tr>
			...
			<td><strong>&nbsp;Due Date:</strong>&nbsp;<?php echo date("d-m-Y", strtotime($invmData['dueDate']));?></strong></td>
		</tr> 
		<tr>
		
			<td colspan="2"><strong>&nbsp;Guest:</strong>&nbsp;<?php echo $invmData['deliveryPlace']; ?></td>
		</tr> 
		</tbody>	
	</table>
	<br>
	<?php if($invmData['invoiceFormat']==1){ ?>
	<table width="100%" border="1" cellpadding="3" bordercolor="#000000" style="border-collapse: collapse;margin-top: 8px;" >
		<tbody>
			...
			<tr style="height: 15px;"> 
				<td width="15%" colspan="3" style="font-size: 13px;text-align:right;"><strong>Total</strong></td>
			...
			<tr>
				<td colspan="4" style="font-size: 12px; height:20px; line-height:1.5;">
               ...
               $infanthsnId = '';
                 ...
                 if($totalAdult>0 && $totalFerryCostA>0){
                     ...
                     if($totalChild>0 && $totalFerryCostC>0){
                       ...
                       <td align="center"><?php echo $totalChild; ?></td>
                       <td align="right"><?php echo $serviceCosteferryC = round($totalFerryCostC*$totalChild,2); ?></td>
                     </tr>
                       <?php
                       }
                       ...
                       if($totalInfant>0 && $totalFerryCostE>0){
                         ...
                         <td align="center"><?php echo $totalInfant; ?></td>
                         <td align="right"><?php echo $serviceCosteferryE = round($totalFerryCostE*$totalInfant,2); ?></td>
                       </tr>
