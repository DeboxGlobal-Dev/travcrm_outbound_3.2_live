...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <td width="7%">
	...
	<input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Active/InActive" onclick="masters_alertspopupopen('action=mastersdelete&name=Pacakege-Theme','600px','auto');" />
	<?php } ?>
	</div>
...
<input name="action" id="action" type="hidden" value="deletepackagetheme" />
...
$where='where name!="" '.$wheresearch2.'and deletestatus=0 order by id desc'; 
$page=$_GET['page'];
 
$targetpage=$fullurl.'showpage.crm?module='.$_GET['module'].'&records='.$limit.'&'; 
$rs=GetRecordList($select,_PACKAGE_THEME_MASTER_,$where,$limit,$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2]; 
...
?>
  <tr>
	...
	<td width="19%" align="left"><?php $select=''; 
$where2=''; 
$rs2='';  
...
<?php
	...
	<td width="4%" align="left"><?php if($resultlists['image']!=''){ ?><img src="packageimages/<?php echo $resultlists['image']; ?>" width="30" /><?php } ?></td>
	<td width="8%" align="left"><?php if($resultlists['image2']!=''){ ?><img src="packageimages/<?php echo $resultlists['image2']; ?>" width="30" /><?php } ?></td>
