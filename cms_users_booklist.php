<?php $pageName='MANAGE BOOKILIST'; 
 
//----Delete Post-----
if(isset($_REQUEST['action']) && $_REQUEST['action']=="del"){
$user_id=$_REQUEST['user_id'];
$id=$_REQUEST['id'];
	$sql_del="delete from  "._WISHLIST_."  where id='".$_REQUEST['id']."'";
	mysqli_query($sql_del) or die(mysqli_error(db()));
	header("location:?module=cms&page=users-booklist&user_id=".$user_id."&id=".$id."&alt=2");	
}
?>
<script>
function cmd_del(){
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
   ...
   <tr>
      ...
      <th align="left" class="header" >User Id</th>
	 <th  align="left" class="header" >Package Code</th>
	 <th  align="left" class="header" >Package Name</th>
	 <th  align="left" class="header" >Booking Date</th>
...
$rs=GetRecordList($select,_WISHLIST_,$where,$limit,$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2]; 
...
?>
  <tr>
    ...
    <td width="13%" align="left"><?php  echo stripslashes($resultlists['user_id']); ?></td>
	
	<td width="15%" align="left"><span class="graylist">
	  <?php  echo stripslashes($resultlists['packageCode']); ?>
	</span></td>
	<td width="18%" align="left"><span class="graylist">
	  <?php  echo stripslashes($resultlists['packageName']); ?>
	</span></td>
