...
<table border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
   ...
   <tr>
    ...
    <label for="checkAll"><span></span>&nbsp;</label></th> 
     <th width="247" align="left" class="header" >Leads Name </th>

     <th width="168" align="left" class="header sortingbg">Company  </th>

     <th width="166" align="left" class="header sortingbg">Email</th>
     <th width="172" align="left" class="header sortingbg">Phone</th>
     <th width="170" align="left" class="header sortingbg">Leads Source</th>
     <th width="170" align="left" class="header sortingbg">Leads Owner </th>
...
$wheresearch=' and assignTo = '.$_SESSION['userid'].' '; 
 
 
 
$where='where userId='.$loginusersuperParentId.' and deletestatu=0 '.$wheresearch.'   order by dateAdded desc'; 
$page=$_GET['page'];
 
$targetpage=$fullurl.'show-page.crm?module=leads&records='.$limit.'&'; 
$rs=GetRecordList($select,_LEADS_MASTER_,$where,$limit,$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2]; 
...
?>
  <tr>
   ...
   <td align="center" valign="middle"><?php if($editpermission==1){ ?><input type="checkbox" id="c<?php echo $no; ?>" name="check_list[]" class="chk"  value="<?php echo encode($resultlists['id']); ?>"/>
    ...
    <td align="left"><?php echo strip($resultlists['email']); ?></td>
    <td align="left"><?php echo strip($resultlists['phone']); ?></td>
    <td align="left"><?php 
$select1='name';  
$where1='id="'.$resultlists['leadsSource'].'"'; 
$rs1=GetPageRecord($select1,_LEADSSOURCE_MASTER_,$where1); 
$res=mysqli_fetch_array($rs1);
echo strip($res['name']); 
?></td>
    <td align="left"><?php 
$select1='firstName,lastName';  
$where1='id="'.$resultlists['assignTo'].'"'; 
