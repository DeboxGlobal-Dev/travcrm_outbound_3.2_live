            ...
            if ($refid1 > 0) {
                ...
                if ($documentType == 'visa') {
                    ...
                    $json_result .= '{
                        ...
                        "visa_1": "https://inboundcrm.in/travcrm-mice_2.2/' . $visa1 . '",
                        "visa_2": "https://inboundcrm.in/travcrm-mice_2.2/' . $visa2 . '",
                        "visa_3": "https://inboundcrm.in/travcrm-mice_2.2/' . $visa3 . '"
                    },';
                    ...
                    $json_result .= '{
                        ...
                        "queryId": "' . $resListing4['id'] . '",
                        "mobile": "' . $resListing1['mobile_number'] . '",
                        "flight_1": "https://inboundcrm.in/travcrm-mice_2.2/' . $flight1 . '",
                        "flight_2": "https://inboundcrm.in/travcrm-mice_2.2/' . $flight2 . '",
                        "flight_3": "https://inboundcrm.in/travcrm-mice_2.2/' . $flight3 . '"
                    },';
                    ...
                    $json_result .= '{
                        ...
                        "queryId": "' . $resListing4['id'] . '",
                        "mobile": "' . $resListing1['mobile_number'] . '",
                        "insurance_1": "https://inboundcrm.in/travcrm-mice_2.2/' . $insurance1 . '",
                        "insurance_2": "https://inboundcrm.in/travcrm-mice_2.2/' . $insurance2 . '",
                        "insurance_3": "https://inboundcrm.in/travcrm-mice_2.2/' . $insurance3 . '"
                    },';
                }
            } else {
                $json_result .= '{
