...
<?php } ?>
		...
		"StartTime": "<?php if($DayWiseData['fromTime']!=0){
					$fromTime=date('H:i',strtotime($DayWiseData['fromTime']))." hrs";
					echo $fromTime;
					} ?>",
		"EndTime": "<?php if($DayWiseData['toTime']!=0){
