...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Delete" onclick="masters_alertspopupopen('action=mastersdelete&name=Conversion','600px','auto');" />
	<?php } ?>
	</div>
    ...
    <td align="right"><table border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <?php if($addpermission==1){ ?><td style="padding-right:20px;"><input name="addnewuserbtn" type="button" class="bluembutton" id="addnewuserbtn" value="+ Add New <?php echo $pageName; ?>" onclick="masters_alertspopupopen('action=currencyconversion&sectiontype=<?php echo clean($_GET['module']); ?>','400px','auto');" /></td> <?php } ?>
      </tr>
...
<input name="action" id="action" type="hidden" value="deletecurrencConversionymaster" />
...
<table border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
   ...
   <tr>
    ...
    <label for="checkAll"><span></span>&nbsp;</label></th> 
      ...
      <th width="21%" align="left" class="header" >fROM Currency </th>
	 <th width="17%"  align="left" class="header" >tO Currency</th>
	 <th width="22%"  align="left" class="header" >Currency Rate </th>
	 <th width="13%"  align="left" class="header" >Created By</th>
	 <th width="17%"  align="left" class="header" >Modified By</th>
	 </tr>
   </thead>
...
$rs=GetRecordList($select,_CURRENCY_CONVERSION_MASTER_,$where,$limit,$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2]; 
...
?>
  <tr>
    ...
    <td align="left"><div class="bluelink" onclick="masters_alertspopupopen('action=currencyconversion&sectiontype=<?php echo clean($_GET['module']); ?>&id=<?php echo $resultlists['id']; ?>','400px','auto');" ><?php echo getCurrencyName($resultlists['currencyFrom']); ?></div>   </td>
	
	<td align="left"><?php echo getCurrencyName($resultlists['currencyTo']); ?></td>
	<td align="left"><?php echo ($resultlists['currencyValue']); ?></td>
