...
<style type="text/css">
	...
	#buttonsbox .upload_quotBanner, #buttonsbox .bluembutton {
	...
	<div class="contentclass">
		...
		<div id="contentbox" class="addeditpagebox" style="  padding:15px; overflow:auto; text-align:left; margin-bottom:0px; " >
			<form action="query_frmaction.php" method="post" enctype="multipart/form-data" name="addmasters" target="actoinfrm" id="addmasters">
				...
				<div class="leftDiv50">
				<div class="griddiv" style="overflow: visible!important;">
					<label>
				...
				<div class="griddiv" style="overflow: visible!important;">	
					<label>
						<div class="labelBorder" >Day/Date&nbsp;Wise</div>
						<div class="gridfield" ><?php echo ($quotationData['dayWise']==2)?'Day Wise':'Date Wise'; ?></div>
					</label>
				</div> 
				</div> 
				...
				<div class="rightDiv50">
					...
					<div class="griddiv" style="overflow: visible!important;">
						<label>
							<div class="labelBorder" >Day/Date&nbsp;Wise</div>
							<select class="gridfield " name="newDayWise" id="newDayWise">
								<option value="1" <?php if($quotationData['dayWise']==1){ ?>selected="selected"<?php } ?> >Date Wise</option>
								<option value="2" <?php if($quotationData['dayWise']==2){ ?>selected="selected"<?php } ?> >Day Wise</option>
							</select>
						</label>
					</div> 
				</div> 
		...
		<div id="contentbox" class="addeditpagebox" style="  padding:15px; overflow:auto; text-align:left; margin-bottom:0px; display:none;" >
			...
			<div id="buttonsbox"  style="text-align:center;">
				<table border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
						<td  ><input name="addnewuserbtn" type="button" class="redmbutton2 submitbtn" id="addnewuserbtn" value=" Re-Generate Now " onclick="formValidation('addmasters','submitbtn','0');" /></td>
					<td ><a href="showpage.crm?module=quotations&view=yes&alt=3&id=<?php echo $_REQUEST['quotationId']; ?>">
					<!-- <input name="Cancel" type="button" class="whitembutton" id="Cancel" value="Cancel" /></a></td> -->
			...
			<form action="query_frmaction.php" method="post" enctype="multipart/form-data" name="addmasters" target="actoinfrm" id="addmasters">
				...
				<div class="griddiv leftDiv50"  >
					...
					<div class="griddiv"  >
						...
						<tr>
							...
							<td>
								<label>
									...
									<input type="number" class="gridfield" id="oldTwin" name="oldTwin" value="<?php echo $quotationData['twinRoom']; ?>" disabled>
								</label>
							</td>
							<td>
								<label>
						...
						<td>
							<label>
								<div class="gridlable" style="width:100%;">CWBed</div>
								<input type="number" class="gridfield" id="oldCWBed" name="oldCWBed" value="<?php echo $quotationData['childwithNoofBed']; ?>" disabled>
							</label>
						</td>
						<td>
							<label>
								<div class="gridlable" style="width:100%;">CNBed</div>
								<input type="number" class="gridfield" id="oldCNBed" name="oldCNBed" value="<?php echo $quotationData['childwithoutNoofBed']; ?>" disabled>
							</label>
						</td>
						<td>
							<label>
								<div class="gridlable" style="width:100%;">ExtraBed</div>
								<input type="number" class="gridfield" id="oldENoofBed" name="oldENoofBed" value="<?php echo $quotationData['extraNoofBed']; ?>" disabled>
							</label>
						</td> 
						...
						<td>
							<label>
								...
								<input type="number" class="gridfield" id="oldQuadNoofBed" name="oldQuadNoofBed" value="<?php echo $quotationData['quadNoofRoom']; ?>" disabled>
							</label>
						</td>
						<?php } ?>
					</tr> 
					<tr>
						...
						<td>
							<label>
								...
								<input type="number" class="gridfield" id="oldTeenNoofBed" name="oldTeenNoofBed" value="<?php echo $quotationData['teenNoofRoom']; ?>" disabled>
							</label>
						</td>
						...
						<td>
							<label>
								...
								<input type="number" class="gridfield" id="oldSixNoofBed" name="oldSixNoofBed" value="<?php echo $quotationData['sixNoofBedRoom']; ?>" disabled>
							</label>
						</td>
						...
						<td>
							<label>
								...
								<input type="number" class="gridfield" id="oldEightNoofBed" name="oldEightNoofBed" value="<?php echo $quotationData['eightNoofBedRoom']; ?>" disabled>
							</label>
						</td>
						...
						<td>
							<label>
								...
								<input type="number" class="gridfield" id="oldTenNoofBed" name="oldTenNoofBed" value="<?php echo $quotationData['tenNoofBedRoom']; ?>" disabled>
							</label>
						</td>
						<?php } ?>
					</tr>
					...
					<div class="griddiv"  >
						...
						<tr>
							...
							<label>
								<div class="gridlable" style="width:100%;">Twin</div>
								<input type="number" class="gridfield" id="newTwin" name="newTwin" value="<?php echo $quotationData['twinRoom']; ?>" >
							</label>
							</td>
							<td>
							<label>
						...
						<tr> 
							...
							<label>
								<div class="gridlable" style="width:100%;">CWBed</div>
								<input type="number" class="gridfield" id="newCWBed" name="newCWBed" value="<?php echo $quotationData['childwithNoofBed']; ?>" onkeyup="balanceCWB(this.value)">
							</label>
							</td>
							<td>
							<label>
								<div class="gridlable" style="width:100%;">CNBed</div>
								<input type="number" class="gridfield" id="newCNBed" name="newCNBed" value="<?php echo $quotationData['childwithoutNoofBed']; ?>" onkeyup="balanceCNB(this.value)">
							</label>
							</td>
							<td>
								<label>
									<div class="gridlable" style="width:100%;">ExtraBed</div>
									<input type="number" class="gridfield" id="newENoofBed" name="newENoofBed" value="<?php echo $quotationData['extraNoofBed']; ?>" >
								</label>
							</td>
							...
							<label>
								<div class="gridlable" style="width:100%;">Quad</div>
								<input type="number" class="gridfield" id="newQuadNoofBed" name="newQuadNoofBed" value="<?php echo $quotationData['quadNoofRoom']; ?>">
							</label>
							</td>
							<?php } ?>
						</tr> 
						<tr>
							...
							<td>
								<label>
									<div class="gridlable" style="width:100%;">Teen</div>
									<input type="number" class="gridfield" id="newTeenNoofBed" name="newTeenNoofBed" value="<?php echo $quotationData['teenNoofRoom']; ?>">
								</label>
							</td>
							<?php } if(isRoomActive('sixbedroom')==true){ ?>
							<td>
								<label>
									<div class="gridlable" style="width:100%;">SixBed</div>
									<input type="number" class="gridfield" id="newSixNoofBed" name="newSixNoofBed" value="<?php echo $quotationData['sixNoofBedRoom']; ?>">
								</label>
							</td>
							<?php } if(isRoomActive('eightbedroom')==true){ ?>
							<td>
								<label>
									<div class="gridlable" style="width:100%;">EightBed</div>
									<input type="number" class="gridfield" id="newEightNoofBed" name="newEightNoofBed" value="<?php echo $quotationData['eightNoofBedRoom']; ?>">
								</label>
							</td>
							<?php } if(isRoomActive('tenbedroom')==true){ ?>
							<td>
								<label>
									<div class="gridlable" style="width:100%;">TenBed</div>
									<input type="number" class="gridfield" id="newTenNoofBed" name="newTenNoofBed" value="<?php echo $quotationData['tenNoofBedRoom']; ?>">
								</label>
							</td>
							<?php } ?>
						</tr>
						...
						<script type="text/javascript">
							function balanceCWB(child){
						  		var totalChild = parseInt($('#newChild').val());
						  		if(totalChild < child){
						  			alert('Max limit is '+totalChild);
						  			$('#newCWBed').val(totalChild);
						  			$('#newCNBed').val(0);
						  		}else{
						  			$('#newCNBed').val(totalChild-child);
						  		}
						  	}
						  	function balanceCNB(child){
						  		...
						  		if(totalChild < child){
						  			alert('Max limit is '+totalChild);
						  			$('#newCNBed').val(totalChild);
						  			$('#newCWBed').val(0);
						  		}else{
						  			$('#newCWBed').val(totalChild-child);
						  		}
						  	}
						</script>
					</div>
