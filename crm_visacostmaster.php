...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <td width="7%">
	...
	<input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Deactivate" onclick="masters_alertspopupopen('action=mastersdelete&name=VisaCost','600px','auto');" />
	<?php } ?>
	</div>
...
<input name="action" id="action" type="hidden" value="deleteVisaCost" />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
   ...
   <tr>
    ...
    <label for="checkAll"><span></span>&nbsp;</label></th> 
     <!-- <th align="left" class="header" >VISA Name </th> -->
     <th align="left" class="header" >VISA Code </th>
     <th align="left" class="header" >Country </th>
     <th align="left" class="header" >VISA Type </th>
     <th align="left" class="header" style="display:none;">Entry Type </th>
     <th align="left" class="header" style="display:none;">Validity </th>
...
$where='where visaType!=""  '.$wheresearch.' and deletestatus=0 order by name asc'; 
...
$rs=GetRecordList($select,'visaCostMaster',$where,$limit,$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2]; 
...
?>
  <tr>
      ...
      <!-- <td width="30%" align="left"><div class="bluelink" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&sectiontype=<?php echo clean($_GET['module']); ?>&id=<?php echo $resultlists['id']; ?>','400px','auto');" ><?php echo $resultlists['name']; ?></div>   </td> -->

      <td align="center"><?php  echo $serviceCode = makeServiceCode('VS',$resultlists['displayId']);  ?></td>
...
//}?></td> -->
<td ><?php $rs1=GetPageRecord('name,id','visaTypeMaster',' id="'.$resultlists['visaType'].'" and status=1 and deletestatus=0 '); 
$resultlists1 = mysqli_fetch_assoc($rs1);
echo $resultlists1['name'];
?></td>


<td width="10%" align="left" style="display:none;"><?php  if($resultlists['entryType']==1){ echo 'Single Entry';}else{ echo 'Multiple Entry'; } ?>   </td>
<td width="10%" align="left" style="display:none;"><?php echo $resultlists['validity']; ?>   </td> 



<td align="left">
            <a href="showpage.crm?module=<?php echo $_REQUEST['module'];?>&amp;view=yes&amp;visaId=<?php echo encode($resultlists['id']);?>">
            <input name="addnewuserbtn" type="button" value="+ Add/View" class="bluembutton">
            </a>
          </td>
<td>
<?php if ($resultlists['status'] == 1) { ?><div style=" width: fit-content; color: green; "><?php echo 'Active'; ?></div><?php } else { ?><div style=" width: fit-content; color: red; "><?php echo 'In Active'; ?></div><?php }  ?>
</td>
