...
<div class="addeditpagebox1" style="padding: 30px;">

    <div class="invoceTempSecInner" style="display: grid;grid-template-columns: auto auto;width:100%;">
           
    
            <!-- First Template Started -->
                <div id="containerBoxId" class="containerBox">
                    <div id="section_first" class="container"  onmouseout="mouseOut();">
                        <img class="imagesSec" align="center" id="imageTemplate_1" src="<?php echo $fullurl; ?>images/Invoice-01.jpg" alt="" width="400px" height="400" style="z-index:-1;">
                    </div>
                    <div class="defaulbtn"><a href="#" onclick="selectTemplate('1');">
                        <?php if($setDefaultTemplate==1){ echo 'Current Template - 1'; }else{ echo 'Set Default Template - 1';} ?></a>
                    </div>
                </div>
                <!-- Firts Template ends -->

                <!-- Second Template Started -->
                <!-- <div class="containerBox">
                    <div id="section_third" class="container temp_hight" onmouseout="mouseOutthird();">
                        <!-- <div id="templateSection_3"> -->
                        <!-- <img align="center" id="imageTemplate_3" src="<?php echo $fullurl; ?>images/template_3.jpg" alt="" width="400px"> -->
                        <!-- </div> -->
                <!-- </div>
                    <div class="defaulbtn"><a href="#" onclick="selectTemplate('2');">
                        <?php if($setDefaultTemplate==2){ echo 'Current Template - 2'; }else{ echo 'Set Default Template - 2'; } ?></a>
                    </div>
                </div> -->
                <!-- Second Template ends -->

                <!-- third template Started -->
                <div class="containerBox">
                    <div id="section_second" class="container"  onmouseout="mouseOutsec();">
                        <img class="imagesSec" align="center" id="imageTemplate_2" src="<?php echo $fullurl; ?>images/Invoice-03.jpg" alt="" width="400px" height="400px">
                    </div>
                    <div class="defaulbtn"><a href="#" onclick="selectTemplate('3');">
                        <?php if($setDefaultTemplate==3){ echo 'Current Template - 3'; }else{ echo 'Set Default Template - 3';} ?></a>
                    </div>
                </div>
                <!-- Third Template ends -->
                ...
                <div class="containerBox">
                    <div id="section_third" class="container"  onmouseout="mouseOutsec();">
                        <img class="imagesSec" align="center" id="imageTemplate_3" src="<?php echo $fullurl; ?>images/Invoice-04.jpg" alt="" width="400px" height="400px">
                    </div>
                    <div class="defaulbtn"><a href="#" onclick="selectTemplate('4');">
                        <?php if($setDefaultTemplate==4){ echo 'Current Template - 4'; }else{ echo 'Set Default Template - 4';} ?></a>
                    </div>
                </div>
                <!-- fourth template Ended -->

                <!-- Fifth template Started -->
                <div class="containerBox">
                    <div id="section_third" class="container"  onmouseout="mouseOutsec();">
                        <img class="imagesSec" align="center" id="imageTemplate_5" src="<?php echo $fullurl; ?>images/Invoice-05.jpg" alt="" width="400px" height="400px">
                    </div>
                    <div class="defaulbtn"><a href="#" onclick="selectTemplate('5');">
                        <?php if($setDefaultTemplate==5){ echo 'Current Template International'; }else{ echo 'Set Default Template International';} ?></a>
                    </div>
                </div>
                <!-- Fifth template Ended -->
...
<script>
    ...
    function selectTemplate(templateId){
        ...
        swal({
                title: "Are you sure?",
                text: "Once selected, this template will be applied to all Invoice!",
                icon: "warning",
                buttons: true,
                // dangerMode: false,
                buttons: ["No!", "Yes"],
                ...
                .then((selected) => {
                if (selected){
                    $("#selectDefaultTemplate").load('final_frmaction.php?action=selectInvoiceTemplates&templateNo='+templateId);
                }
                });
    }
