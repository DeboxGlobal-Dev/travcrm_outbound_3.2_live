	...
	if(mysqli_num_rows($qIQuery2) > 0){	
		...
		while($finalIt_Data2=mysqli_fetch_array($qIQuery2)){ 
			...
			<tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" >
					...
					<table width="100%" border="0" cellspacing="0" borderColor="#ccc" cellpadding="0" style="">
						<tr>
							<td width="50%">
						...
						<tr> 
							...
							<td width="30%"><?php if($queryfromDate2!='1970-01-01' && $queryfromDate2!='0000-00-00' && $queryfromDate2!=''){ echo date('j M Y', strtotime($queryfromDate2)); }else{ echo date('j M Y',strtotime($queryfromDate)); } ?>
							</td>
							<td>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" >
						<tr> 
							<td width="50%"><strong>In favour of:</strong></td>
							<td width="30%"><?php echo $leadPaxName; ?></td>
							<td ><?php echo $quotationData['adult']." Adult(s)" ; if($quotationData['child']>0 || $quotationData['child']=''){ echo ', '.$quotationData['child']." Child(s)"; } ?></td>
						</tr>
					</table>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" >
					   <tr>
						  <td width="50%"><strong>Lead&nbsp;Pax&nbsp;Name&nbsp;:&nbsp;</strong></td>
						  <td width="30%"><span  style="width:140px;  padding:3px; "><?php echo strip($resultpage['leadPaxName']);  ?></span></td>
						  <td >&nbsp;</td>
					   </tr>
					</table> 
					<br />
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" >
						<tr> 
							<td width="17%"><strong>Services:</strong></td>
							<td width="80%"><strong>Please provide the services as per the following.</strong></td> 
						</tr>
					</table> <br />
					<br />
		...
		?>
			...
			<!-- Value Added Services Block Ends -->
					...
					<table width="100%" border="1" cellspacing="0" cellpadding="5" borderColor="#ccc"   style="font-size:13px;"> 
						...
						<?php } ?>
						<tr> 
							<td colspan="8"><strong style="font-size: 14px;"><em><?php echo date('d M Y',strtotime($finalIt_Data2['startDate']));?></em></strong></td>
						</tr>
						<?php
						//serial wise loop
						$qIQuery='';
								...
								while($finalQuoteTrains=mysqli_fetch_array($trainQuery)){
									...
									<tr> 
										<td  colspan="8">
											...
											<table width="100%" border="1" cellspacing="0" borderColor="#ccc" cellpadding="5" style="font-size:13px;"> 
											<tr>
												<td bgcolor="#133f6d" style="color:#ffffff;font-size: 16px"colspan="8">
											...
											<tr> 
												<td colspan="8"><?php echo strip($trainName); echo "&nbsp;/Journey&nbsp;Type - ".$journeyType; ?></td>  
											...
											<tr> 
												<td colspan="2"><?php echo $trainNumber; ?></td> 
												<td colspan="2"><?php echo strip($departureFrom); ?></td> 
												<td colspan="2"><?php echo strip($arrivalTo); ?></td> 
												<td colspan="2"><?php echo $trainClass; ?></td> 
											</tr>
											<tr>
												<td colspan="2">
											...
											<tr>
												<td colspan="2"><?php echo $departureDate; ?></td> 
												<td colspan="2"><?php echo $departureTime; ?></td> 
												<td colspan="2"><?php echo $arrivalDate; ?></td> 
												<td colspan="2"><?php echo $arrivalTime; ?></td> 
											</tr>
											</table>
										</td> 
									</tr>
