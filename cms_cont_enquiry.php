<?php $pageName='  CONTACT ENQUIRIES'; 
			...
			<div id="pagelisterouter" class="cmsPageBox">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
				  ...
				  <?php
					...
					$where='where type="contact_enquiry" order by id desc'; 
					$page=$_GET['page'];
				  ...
				  <tr>
					...
					<td width="10%" align="left"> <?php echo $mobile; ?> </td>
					...
					<td width="11%" align="left"><a href="showpage.crm?module=cms&page=view_cont_enquiry&cid=<?php echo $resultlists['id']; ?>">View Detail</a></td>
