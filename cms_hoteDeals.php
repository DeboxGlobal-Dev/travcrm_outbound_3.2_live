<?php 
  ...
  if(isset($_REQUEST['action']) && $_REQUEST['action']=="del"){
      ...
      header("location:?module=cms&page=hotdeal&alt=2");
  }
    ...
    <td width="91%" align="left" valign="top">
      <form id="listform" name="listform" method="get">
        ...
        <div id="pagelisterouter" class="cmsPageBox">
          <input name="action" id="action" type="hidden" value="hotdeal" />
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
            ...
            <tbody>
              <?php
                ...
                $where='where type="hotdeal" order by id desc';
                $page=$_GET['page'];
                ...
                while($resultlists=mysqli_fetch_array($rs[0])){
                  ...
                  <tr>
                    ...
                    <td width="10%" align="center">
                      ...
                      <a href="showpage.crm?module=cms&page=hotdeal&status=0&id=<?php echo $resultlists['id']; ?>"> <img src="images/unlock.png" width="30" border="0" /> </a>
                      <?php } else { ?>
                      <a href="showpage.crm?module=cms&page=hotdeal&status=1&id=<?php echo $resultlists['id']; ?>"> <img src="images/lock.png" /> </a>
                      <?php } ?>
                    </td>
                    <td width="10%" align="center">
                    ...
                    <td width="10%" align="center">
                      <a href="?module=cms&amp;page=hotdeal&amp;id=<?php echo $resultlists['id']; ?>&amp;action=del" onclick="return cmd_del()"> 
