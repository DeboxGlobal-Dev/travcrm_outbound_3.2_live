...
if($invoiceId!='' && is_numeric($invoiceId)){
  ...
  $totalClientCostWithMarkup = round($prmData['totalClientCostWithMarkup']+$totalISOCost+$totalConsortiaCost+$totalClientCommCost,2);
...
<table width="100%" border="0" style="max-height:50px;border-collapse: collapse;" ><tbody>
		...
		<tbody>
			<tr>
				...
				<td width= "70%" style="font-size: 11px; ">
                    ...
                    <?php if($resultInvosiceSetting['companyname']!=''){ ?>
				    <strong>&nbsp;<?php echo $resultInvosiceSetting['companyname']; ?></strong><br>
                    <?php } ?>

                    <?php if($resultInvoiceSetting['address']!=''){ ?>
				    <strong>&nbsp;Address:</strong>&nbsp;<?php echo $resultInvoiceSetting['address']; ?><br>
                    <?php } ?>

                    <?php if($resultInvoiceSetting['phone']!=''){ ?>
		...
		<tbody>
			<tr>
				<td width="45%" rowspan="5" style="font-size: 12px;">
                    ...
                    <?php if($queryData['guest1phone']!=''){ ?>
					<strong>&nbsp;Phone:&nbsp;</strong><?php echo $queryData['guest1phone']; ?><br>
                    <?php } ?>


                    <?php if($queryData['guest1email']!=''){ ?>
                    ...
                    <?php if($resultCompany['TRNNumber']!=''){ ?>
					<strong>&nbsp;TRN:&nbsp;</strong><?php echo $resultCompany['TRNNumber']; ?><br>
                    <?php } ?>

                    <?php if($resultCompany['countryId']!=''){ ?>
            ...
            <tr>
				<td><strong>&nbsp;</strong>Guest Name:<strong>&nbsp;<?php echo $invmData['guestName'];?></strong></td>
                <td><strong>&nbsp;</strong>Total Pax:<strong>&nbsp;
                    <?php echo $noofpax; ?>
                </strong> </td>
			</tr>
            <tr><td colspan="2" ><strong>&nbsp;</strong>File No.:<strong>&nbsp;<?php if($invmData['referNo']!=''){ echo $invmData['fileNo']; }  ?></strong> </td>
            
        
            </tr>
			<!-- <tr>
				<td colspan="3" style="height: 45px; font-size: 14px; "><strong>&nbsp;</strong>Place of Delivery :<strong>&nbsp;<?php echo ($invmData['deliveryPlace']); ?></strong></td>
			</tr> -->
		</tbody>	
	</table>
	...
	<table width="100%"  border="1" cellpadding="3" bordercolor="#000000" style="border-collapse: collapse; border-top: 0px solid #fff;">
		<tbody>
			<tr style="height: 25px;">
				<td colspan="1" width="5%" style="font-size: 13px; text-align:center;"><strong>SN</strong></td>
				<td  colspan="10" width="70%" style="font-size: 13px;text-align:left;padding-left: 50px;"><strong>Particulars</strong></td>
				...
				<td width="25%" colspan="1" style="font-size: 13px;text-align:right;"><strong>Amount&nbsp;<span style="
				font-size:10px;">(In<strong>&nbsp;</strong><?php echo getCurrencyName($currencyId); ?>)</span></strong></td>		
			</tr>

			<tr height="80" >
				<td width="5%" style="text-align: center;" colspan="1">1</td>
				<td colspan="10" width="70%" valign="middle" style="font-size: 13px; text-align:left;">
				...
				<td colspan="1" width="25%" align="right" valign="middle" width="15%" style="font-size: 13px;" ><strong><?php 
					echo round(getChangeCurrencyValue_New($baseCurrencyId,$quotationId,$totalClientCostWithMarkup),2); ?><br>
          <?php 
          ...
          ?>
			...
			<tr style="height: 15px;" colspan=""  style="">

				<td colspan="9"  width=""  style="font-size: 13px;text-align:center;border:0px solid;"><strong></strong></td>
                <td colspan="2" width="" style="font-size: 12px;text-align:center;"><strong>Non Taxable Amount</strong></td>
				<td colspan="1" width="" style="font-size: 12px; text-align: right;"><strong><?php echo $nonTaxableAMT;?></strong></td>	
                
			</tr>
      <?php } ?>
            <tr style="height: 15px;" colspan="12" >

            <td colspan="9" width=""  style="font-size: 13px;text-align:center;border:0px solid;"><strong></strong></td>
                <td colspan="2" width="" style="font-size: 11px;text-align:center;"><strong>Taxable Amount</strong></td>
				<td colspan="1" width="" style="font-size: 12px; text-align: right;"><strong><?php echo $taxableAMT; ?></strong></td>	
                
			</tr>

            <tr style="height: 15px;" colspan="">

				<td colspan="9" width="" style="font-size: 13px;text-align:center;border:0px solid;"><strong></strong></td>
                <td colspan="2" width="" style="font-size: 12px;text-align:center;"><strong>
				...
				<td colspan="1" width="" style="font-size: 12px; text-align: right;"><strong><?php echo $totalServiceTaxCost; ?>
      </strong></td>	
            ...
            <tr style="height: 15px;" colspan="">
				...
				<td colspan="9" width=""  style="font-size: 13px;text-align:center;border:0px solid;"><strong></strong></td>
                <td colspan="2" width="" style="font-size: 12px;text-align:center;"><strong>Total Amount</strong></td>
				<td colspan="1" width="" style="font-size: 12px; text-align: right;"><strong><?php echo $totalClientCostInWord = round(getChangeCurrencyValue_New($baseCurrencyId,$quotationId,$totalClientCost),2);?></strong></td>	
			...
			<tr>
				<td colspan="12" style="font-size: 12px; height:20px; line-height:1.5;">
	...
	<?php }elseif($invmData['invoiceFormat']==2){ ?>
        ...
        $rs11 = GetPageRecord('*','finalQuote','quotationId="'.$quotationId.'" and manualStatus="3" group by hotelId order by fromDate asc');
  ...
  // }
    ...
    <div style="text-align: center">
        <p style="font-size: 10;">Kindly make payments of in favour of <b><?php echo $resultInvoiceSetting['companyname']; ?></b></p>
    </div>
...
<table width="100%" style="margin-top: 10px;">
	<tbody>
	<?php if($invmData['invoiceNotes']!=''){ ?>
  <tr>
		<td align="left" style="font-size: 12px;"><strong>Notes</strong></td>
	</tr>
	<tr>
  ...
  <?php } if($invmData['terms']!=''){ ?>
  <tr>
		<td align="left" style="font-size: 12px;"><strong>Terms & Conditions</strong></td>
	</tr>
	<tr>
  ...
  <?php } if($invmData['payment']!=''){ ?>
  <tr>
		<td align="left" style="font-size: 12px;"><strong>Payment</strong></td>
	</tr>
	<tr>
