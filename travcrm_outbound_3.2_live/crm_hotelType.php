...
<input name="action" id="action" type="hidden" value="deleteHotelType" />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-striped table-bordered" id="mainsectiontable">
   ...
   <tr>
    ...
    <label for="checkAll"><span></span></label></th> 
     <th width="40%" align="left" class="header" >Name </th>
...
$rs=GetRecordList($select,_HOTEL_TYPE_MASTER_,$where,$limit,$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2]; 
