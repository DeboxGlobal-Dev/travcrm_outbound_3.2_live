...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Delete" onclick="alertspopupopen('action=corportatedelete&name=Meetings','600px','auto');" />
	<?php } ?>
	</div>
...
<input name="action" type="hidden" value="meetingsdelete" id="action" />
...
$targetpage=$fullurl.'showpage.crm?module=meetings&records='.$limit.'&searchField='.$searchField.'&assignto='.$_GET['assignto'].'&'; 
