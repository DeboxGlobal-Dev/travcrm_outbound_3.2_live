...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <td width="7%">
    ...
    <td width="50%"><div class="headingm" style="margin-left:30px;"><span id="topheadingmain"><?php echo $pageName; ?></span>
...
<input name="action" id="action" type="hidden" value="deletecabintype" />
<input name="module" id="module" type="hidden" value="<?php echo clean($_GET['module']); ?>" />

<table width="98%" border="1" bordercolor="#ccc" cellpadding="10" cellspacing="0" class="table table-striped table-bordered" id="mainsectiontable">
   ...
   <tr>
    ...
    <th align="left" class="header" >Cruise Name</th> 
...
$rs=GetRecordList($select,_CABIN_TYPE_,$where,$limit,$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2]; 
...
$crs = GetPageRecord('*','cruiseNameMaster','id="'.$resultlists['cruiseNameId'].'"');
$cNameData = mysqli_fetch_assoc($crs);

$cccc = GetPageRecord('*','cruiseCompanyMaster','id="'.$cNameData['cruiseCompanyId'].'"');
$cccNameData = mysqli_fetch_assoc($cccc);
...
?>
  <tr>
    ...
    <td width="20%" style="font-weight: 500;"><?php echo $cccNameData['name']; ?></td>
    <td width="20%" style="font-weight: 500;"><?php echo $cNameData['name']; ?></td>
    <td width="40%" align="left"><div class="bluelink" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&sectiontype=<?php echo clean($_GET['module']); ?>&id=<?php echo $resultlists['id']; ?>','400px','auto');" ><?php echo $resultlists['name']; ?></div>   </td>
