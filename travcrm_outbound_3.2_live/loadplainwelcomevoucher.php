...
if($resultpage['clientType']=='1'){
  ...
  $select1='*';   
  $where1='letterType="plainwelcomeLetter"'; 
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td style="font-size:13px;"><br />Date: <?php if($resultpage['fromDate']!=''){ echo date('j-F-Y',strtotime($resultpage['fromDate'])); }?></td>

  </tr>

  <tr>

    <td style="font-size:13px;"><br /><?php echo $editresult['greetingNote'].' '.$resultpage['leadPaxName']; ?>,</td>
  ...
  <!-- <tr>
    ...
    <td style="font-size:15px;text-align:center;"><br />      A warm welcome from  <?php //echo $resultCompany['companyName']; ?> !</td>
...
<?php if($_REQUEST['planinwelcomeLetter']!='yes'){ ?>
<div style="background-color: #F7F7F7; padding: 5px; border: 1px solid #e5e5e5; margin-bottom:10px; margin:10px; margin-top:0px; margin-bottom:20px;    margin-top: -10px;"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="2" align="left"><a style="border:1px solid #ccc; padding:3px 12px; font-size:12px; background-color:#000; color:#FFFFFF !important; cursor: pointer;" href="<?php echo $fullurl; ?>showpage.crm?module=query&view=yes&id=<?php echo encode($resultpage['id']); ?>&planinwelcomeLetter=yes">Send</a></td>
