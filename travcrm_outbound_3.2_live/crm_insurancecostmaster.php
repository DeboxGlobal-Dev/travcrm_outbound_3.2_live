...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <td width="7%">
	...
	<input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Deactivate" onclick="masters_alertspopupopen('action=mastersdelete&name=insuranceCost','600px','auto');" />
	<?php } ?>
	</div>
...
<input name="action" id="action" type="hidden" value="deleteInsuranceCost" />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
   ...
   <tr>
    ...
    <th align="left" class="header" >Insurance Code </th>
     <th align="left" class="header" >Insurance Name </th>
     <th align="left" class="header" >Insurance Type </th>
...
$rs=GetRecordList($select,'insuranceCostMaster',$where,$limit,$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2]; 
...
?>
  <tr>
      ...
      <td align="center"><?php  echo $serviceCode = makeServiceCode('IN',$resultlists['displayId']);  ?></td>
...
<td><?php 
$rs1=GetPageRecord('name,id','InsuranceTypeMaster',' id="'.$resultlists['insuranceType'].'" and status=1 and deletestatus=0 '); 
$resultlists1 = mysqli_fetch_assoc($rs1);
echo $resultlists1['name'];
?></td>
<td> <a href="showpage.crm?module=<?php echo $_REQUEST['module'];?>&amp;view=yes&amp;insuranceId=<?php echo encode($resultlists['id']);?>">
