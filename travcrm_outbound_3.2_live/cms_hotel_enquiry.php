					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
					    <thead>
						    <tr>
								...
								<th  align="left" class="header" >Hotel Name</th>
								<th  align="left" class="header" >Email</th>
								<th  align="left" class="header" >Mobile Number</th>
								<th  align="left" class="header" >Guests</th>
								<th  align="left" class="header" >Rooms</th>
						...
						<tbody>
							...
							$where='where type="hotel_enquiry" order by id desc'; 
							$page=$_GET['page'];
							...
							while($resultlists=mysqli_fetch_array($rs[0])){ 
								$hotel_name = $resultlists['title'];
								$email = $resultlists['email'];
								$mobile = $resultlists['home_text'];
								$city = $resultlists['city'];
								$hotel_comment = $resultlists['description'];
								$hotel_check_in = $resultlists['post_date'];
								$hotel_check_out = $resultlists['edit_date'];
								$hotel_guests = $resultlists['detail1'];
								$hotel_rooms = $resultlists['detail2'];
								$add_date = $resultlists['add_date'];
								?>
								<tr>
								  	<td width="10%" align="left"><?php echo ++$cnt;?></td>
									<td width="10%" align="left"> <?php echo $hotel_name; ?> </td>
									<td width="10%" align="left"> <?php echo $email; ?> </td>
									<td width="5%" align="left"> <?php echo $mobile; ?> </td>
									<td width="4%" align="left"> <?php echo $hotel_guests; ?> </td>
									<td width="3%" align="left"> <?php echo $hotel_rooms; ?> </td>
									<td width="11%" align="left"><a href="showpage.crm?module=cms&page=view_hotel_enquiry&hid=<?php echo $resultlists['id']; ?>">View Detail</a></td>
