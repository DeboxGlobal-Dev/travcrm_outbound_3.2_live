...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Deactivate" onclick="masters_alertspopupopen('action=mastersdelete&name=transferType','600px','auto');" />
    ...
    <td align="right"><table border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <?php if($addpermission==1){ ?><td style="padding-right:20px;"><input name="addnewuserbtn" type="button" class="bluembutton" id="addnewuserbtn" value="+ Add <?php echo "Transfer Type Name"; ?>" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&sectiontype=<?php echo clean($_GET['module']); ?>','400px','auto');" /></td> <?php } ?>
...
<input name="action" id="action" type="hidden" value="deletetransfertype" />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-striped table-bordered" id="mainsectiontable">
   ...
   <tr>
     ...
     <th align="left" class="header" >Transfer Type Name </th>
...
$rs=GetRecordList($select,'transferTypeMaster',$where,$limit,$page,$targetpage); 
