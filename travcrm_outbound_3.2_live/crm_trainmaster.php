...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td><div class="headingm" style="margin-left:5px;"><span id="topheadingmain"><?php echo 'Train';//$pageName; ?></span>
...
.dropdown-content,.searchbtnmain,.bluembutton,.topsearchfiledmain { 
  ...
  <?php   $dirname =  'Trains_Log/'; 
$images = scandir($dirname);
krsort($images);
foreach (array_slice($images, 0, 5) as $file) {
    if (substr($file, -4) == ".log" ) {
        ?>
		<a href="<?php echo $fullurl; ?>Trains_Log/<?php echo $file; ?>" target="_blank"><?php echo $file; ?></a>
		<?php  
    }
}
 ?>
...
<table border="0" cellpadding="0" cellspacing="0" class="table table-striped table-bordered" id="mainsectiontable">
   ...
   <tr>
       ...
       <th width="15%" align="center" class="header" >Train Code</th>
      <th width="10%" align="left" class="header" >Image</th> 
      <th align="left" class="header" >Train Name </th>
...
$where='where  trainName!=""  '.$wheresearch.''.$wheresearch2.''; 
...
?>
  <tr>
    ...
    <td align="center"><?php  echo $serviceCode = makeServiceCode('TR',$resultlists['displayId']);  ?></td>
    ...
    <!--<td align="left"><div class="bluelink" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&id=<?php echo $resultlists['id']; ?>&section=<?php echo clean($_GET['module']); ?>','400px','auto');" ><?php echo $resultlists['trainName']; ?></div>   </td> -->
