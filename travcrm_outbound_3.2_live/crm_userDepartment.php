  ...
  <tr>
    ...
    <td align="right"><table border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <?php if($addpermission==1){ ?><td style="padding-right:20px;"><input name="addnewuserbtn" type="button" class="bluembutton" id="addnewuserbtn" value="+ Add New Department" onclick="add();" /></td> <?php } ?>
      </tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
   ...
   <tr>
     ...
     <th width="220" align="left" class="header" >Department&nbsp;name </th>
    ...
    <!-- <th width="472" align="left" class="header">Profile&nbsp;Description </th>---->
     ...
     <th width="74" align="center" class="header" style="width:50px;">Action</th>
    </tr>
   </thead>
...
$rs=GetRecordList($select,departmentMasters,$where,$limit,$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2]; 
...
?>
  <tr>
    <td align="center" style="padding-left:0px;padding-right:0px;"><?php if($editpermission==1){ ?><?php if($resultlists['id']!=0){ ?><div style="width:30px;"><img src="images/editicon.png" class="editicon" onclick="edit('<?php echo encode($resultlists['id']); ?>');" /></div><?php } ?><?php } ?></td>
   

  
    <td align="left" valign="top"><div class="bluelink"<?php if($editpermission==1){ ?><?php if($resultlists['id']!='0'){ ?>onclick="edit('<?php echo encode($resultlists['id']); ?>');"<?php } } ?> ><?php echo strip($resultlists['department']); ?></div></td>

   <!--- <td align="left" valign="top"><?php echo strip($resultlists['profileDetails']); ?></td>
--->
    <td align="left" valign="top"><?php if($resultlists['id']!=0){ ?><?php 
...
?>
    ...
    <td align="center" valign="top"style="width:50px;"><?php if($editpermission==1){ ?><?php if($resultlists['id']!='0'){ ?>
    <?php if($deletepermission==1){ ?>  <a class="redtextc" onclick="$('#dids').val('<?php echo encode($resultlists['id']); ?>');alertspopupopen('action=deletedepartment','auto');" >Delete</a><?php } ?>      <?php }  } ?></td>
    </tr> 
	
	<?php $no++; } ?>
</tbody></table>
<?php if($no==1){ ?>
<div class="norec">No <?php if($_GET['useractiveinactiveuser']==0 && $_GET['useractiveinactiveuser']!=''){ echo 'Inactivate'; } else { echo 'Active'; } ?> User Department </div>
<?php } ?>
