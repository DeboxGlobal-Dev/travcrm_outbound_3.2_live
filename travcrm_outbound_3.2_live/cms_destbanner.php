    ...
    <td width="91%" align="left" valign="top">
      <form id="listform" name="listform" method="get">
        ...
        <div id="pagelisterouter" class="cmsPageBox">
          <input name="action" id="action" type="hidden" value="Destbanner" />
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
            ...
            <tbody>
              <?php
                ...
                $where='where type="Destbanner" order by id desc';
                $page=$_GET['page'];
                ...
                while($resultlists=mysqli_fetch_array($rs[0])){
                  ...
                  <tr>
                    ...
                    <td width="20%" align="left">
                      <div class="bluelink" onclick="cms_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&page=<?php echo clean($_GET['page']); ?>&id=<?php echo $resultlists['id']; ?>','800px','auto');" ><?php echo $resultlists['title']; ?></div>   
                    </td>
                    ...
                    <td width="15%" align="left">
                      <?php if($resultlists['image1']!=''){ ?>
                        <img src="<?php echo $fullurl; ?><?php echo $resultlists['image1']; ?>" height="100" />
                      <?php }else{ echo "not found!!"; }  ?>
                    </td>
                    <td width="10%" align="center">
                      <?php if($resultlists['status']==1){ ?>
                      <a href="showpage.crm?module=cms&page=Destbanner&status=0&id=<?php echo $resultlists['id']; ?>"> <img src="images/unlock.png" width="30" border="0" /> </a>
                      <?php } else { ?>
                      <a href="showpage.crm?module=cms&page=Destbanner&status=1&id=<?php echo $resultlists['id']; ?>"> <img src="images/lock.png" /> </a>
                      <?php } ?>
                    </td>
                    <td width="10%" align="center">
                    ...
                    <td width="10%" align="center">
                      <a href="?module=cms&amp;page=Destbanner&amp;id=<?php echo $resultlists['id']; ?>&amp;action=del" onclick="return cmd_del()"> 
