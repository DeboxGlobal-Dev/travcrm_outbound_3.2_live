...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><div class="headingm" style="margin-left:5px;"><span id="topheadingmain"><?php if($_REQUEST['dashboard']!=''){?><a href="http://travcrm.in/"><img src="images/backicon.png" width="20" style=" cursor:pointer;" /></a><?php } ?>&nbsp;&nbsp;&nbsp; Train Package</span>
...
<div style="font-size:20px; font-weight:600;"><?php echo countlisting('id','queryMaster','where queryStatus=10 and moduleType=6  and deletestatus=0  '); ?></div>
...
<div style="font-size:20px; font-weight:600;"><?php echo countlisting('id','queryMaster','where queryStatus=2 and moduleType=6  and deletestatus=0 '); ?></div>
...
<div style="font-size:20px; font-weight:600;"><?php echo countlisting('id','queryMaster','where queryStatus=3 and moduleType=6  and deletestatus=0 '); ?></div>
...
<div style="font-size:20px; font-weight:600;"><?php echo countlisting('id','queryMaster','where queryStatus=6  and moduleType=6 and deletestatus=0 '); ?></div>
...
<div style="font-size:20px; font-weight:600;"><?php echo countlisting('id','queryMaster','where queryStatus=7  and moduleType=6 and deletestatus=0 '); ?></div>
...
<div style="font-size:20px; font-weight:600;"><?php echo countlisting('id','queryMaster','where queryStatus=20  and moduleType=6 and deletestatus=0 '); ?></div>
...
<div style="font-size:20px; font-weight:600;"><?php echo countlisting('id','queryMaster','where queryStatus=4  and moduleType=6 and deletestatus=0 '); ?></div>
...
echo $where;
$targetpage=$fullurl.'showpage.crm?module=trainpackage&records='.$limit.'&searchField='.$searchField.'&assignto='.$_GET['assignto'].'&queryshow='.$_REQUEST['queryshow'].'&searchdate='.$_REQUEST['searchdate'].'&thismonth='.$_REQUEST['thismonth'].'&';
...
setupbox('showpage.crm?module=trainpackage&edit=yes&id='+id+'');
}
...
setupbox('showpage.crm?module=query&view=yes&id='+id+'');
    ...
    <td align="left" ><?php if($resultlists['moduleType']==3){?> <div class=" <?php echo 'pack2'; ?>">Train Package</div><?php } ?></td>
