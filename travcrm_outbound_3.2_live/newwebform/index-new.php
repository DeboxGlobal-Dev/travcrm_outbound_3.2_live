...
/*---- start code by sunil ----*/
	...
	.ui-datepicker-div { background: #666 !important; color: #fff !important;}
	.ui-datepicker .ui-datepicker-header { background: #666 !important; color: #fff !important;}

	.ui-datepicker .ui-datepicker-title{ background: #666 !important; color: #fff !important; font-weight: bold !important;
    font-size: 16px;}

	.ui-datepicker { background: #666 !important; color: #fff !important; padding: 5px !important; border-radius: 5px !important;}
	.ui-datepicker th{background: #FFCC33 !important;  border: 1px solid #1a90c8 !important;}
	.ui-datepicker td {border: 1px solid #1a90c8 !important;}
              ...
              <div class="side-block-search">
                 <div class="page-search-p" style="padding-top:0;">
                    <div class="srch-tab-line">
                       <div class="srch-tab">
                          <label for="country">Going to</label>
                          <div class="input-a">
...
$(".popup-date-inner").addClass('popupdateinnernew');
  ...
  $("#anytimedate").val('Anytime');
          ...
          <a onClick="resetbuttons();$('#resetbtndiv').hide();$('.popup-date-inner').removeClass('popupdateinnernew');" id="resetbtndiv" style="display: none;" class="xbtn">x</a>
                             <input type="text" id="fixdate" name="fixdate" class="popup-date-inner" autocomplete="off" placeholder="Fixed Date" value="" onFocus="$('#resetbtndiv').show();" readonly="">
                             <input type="text" id="flexibledate" name="flexibledate" class="popup-date-inner" autocomplete="off" placeholder="Flexible Date" value="" readonly="" onClick="$("#bookmyticketshow").hide();">
                             <input type="text" id="anytimedate" name="anytimedate" class="popup-date-inner" autocomplete="off" placeholder="Anytime" value=""  readonly="" onClick="$('#bookmyticketshow').hide(); anytime();">
              ...
              <div class="week-picker"></div> 
               ...
               $('#durationfilter').val(totalduration)
                       ...
                       <div class="srch-tab">
                          <label for="email">Email<span style="color:#ff0000;"> *</span><span id="emailvalidation" style="color:#ff0000; display: none;font-size: 12px;    " >Please enter your email address</span></label>
                          <div class="input-a">
                             <input type="text" autocomplete="off" placeholder="Email" name="email" id="email" onKeyUp="emailvalidation123()"   >
                             <span class="date-icon"></span>
                          </div>
                       </div>
                       <div class="srch-tab">
                          <label for="mobileNumber">Mobile Number<span style="color:#ff0000;"> *</span><span id="phonenovalidation" style="color:#ff0000; display: none;font-size: 12px;    " >Please enter your contact no</span></label>
                          <div class="input-a">
                      ...
                      <div class="srch-tab">
                       ...
                       <div class="questions" id="flight_requirement" ng-show="flight_requirementShown">
                           ...
                           <ul class="list-inline list-checkbox margin-bottom-25 margin-left-25 options">
                               ...
                               <li><input class="" type="radio" name="flight_requirement" value="98" id="flight_requirement_98" onChange="addAirfarefun(this);"><label for="flight_requirement_98">No</label>
                               </li>
                            </ul>
                        </div> 
     ...
     $(document).ready(function() {
        ...
        if(email!=""){ 
          ...
          if(mobileNumber!=""){
		 	...
		 	function validateMobile(mobileNumber) {
			   ...
			   if (mobileNumber.length > 15) {
				   $('#phonenovalidation').text("Please Enter 10 digit Mobile Number");
				   $('#mobileNumber').focus();
				   return false;
			   }
				...
				// 	return true;
				// } else {
				// 	$('#phonenovalidation').text("Please enter Correct Mobile Number");
				//     $('#mobileNumber').value = "";
				//     $('#mobileNumber').focus();
				// 	return false;
				// }     
		 ...
		 // check that all error variables are true than call ajax
          ...
          if(error_country == true && error_exploredesti == true && error_leavingForm == true && error_email == true && error_mobileNumber == true && error_fixdate == true && error_durationfilter == true && error_durationfilter == true){
        ...
        $("#submitfromdebox").click(function(event){
          ...
          var flight_requirement_97=$("#flight_requirement").val();
