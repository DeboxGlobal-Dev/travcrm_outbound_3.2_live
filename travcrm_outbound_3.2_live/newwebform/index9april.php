		 ...
		 // check that all error variables are true than call ajax
          ...
          if(error_country == true && error_exploredesti == true && error_leavingForm == true && error_email == true && error_mobileNumber == true && error_fixdate == true && error_durationfilter == true && error_durationfilter == true){
			...
			$.ajax({
				...
				data:{country:country,exploredesti:exploredesti,bookmyticket:bookmyticket,leavingForm:leavingForm,fixdate:fixdate,flexibledate:flexibledate,anytimedate:anytimedate,email:email,mobileNumber:mobileNumber,durationfilter:durationfilter},
				type:'post',
