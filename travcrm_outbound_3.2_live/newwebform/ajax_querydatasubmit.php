<?php
  ...
  $email=$_POST['email'];
  $nameNN=$_POST['nameNN'];
  $lnameNN=$_POST['lnameNN'];
  $newweb=$_POST['newweb'];
  $clientType=$_POST['clientType'];
  $contryCode=$_POST['contryCode'];

  // <!-- SGL,DBL,TWIN,TPL,ExtraBed,CWBed,CNBed ,clientType,contryCode-->
  $SGL=$_POST['SGL'];
  $DBL=$_POST['DBL'];
  $TWIN=$_POST['TWIN'];
  $TPL=$_POST['TPL'];
