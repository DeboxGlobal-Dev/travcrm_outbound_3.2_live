    ...
    <td width="91%" align="left" valign="top">
      <form id="listform" name="listform" method="get">
            ...
            <tr>
              ...
              <td>
                <div class="headingm" style="margin-left:10px;">
                  <span id="topheadingmain">SAC Code Master</span>
                  <div id="deactivatebtn" style="display:none;">
                    <?php if ($deletepermission == 1) { ?>

                      <input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Deactivate" onclick="masters_alertspopupopen('action=mastersdelete&name=SACCode','600px','auto');" />
                    <?php } ?>
                  </div>
              ...
              <td align="right">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <?php if ($addpermission == 1) { ?><td style="padding-right:20px;"><input name="addnewuserbtn" type="button" class="bluembutton" id="addnewuserbtn" value="+ Add SAC Code" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&sectiontype=<?php echo clean($_GET['module']); ?>','450','auto');" /></td> <?php } ?>
                  </tr>
        ...
        <div id="pagelisterouter" style="padding-left:30px;">
          <input name="action" id="action" type="hidden" value="SACcodedelete" />
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-striped table-bordered" id="mainsectiontable">
            ...
            <thead>
              ...
              <tr>
                <th width="2%" align="left" class="header">SN</th>
                ...
                <th align="left" class="header">SAC Code </th>
            ...
            <tbody>
              ...
              if ($_GET['keyword'] != '') {
                $wheresearch = "and serviceType like '%" . $_GET['keyword'] . "%'";
              }
              ...
              $where = 'where  serviceType!=""  ' . $wheresearch2 . ' ' . $wheresearch . ' and deletestatus=0  order by serviceType asc';
              ...
              $rs = GetRecordList($select, 'sacCodeMaster', $where, $limit, $page, $targetpage);
              $totalentry = $rs[1];
              $paging = $rs[2];
              ...
              ?>
                <tr>
                  ...
                  <td width="8%" align="left">
                    <div class="bluelink" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&sectiontype=<?php echo clean($_GET['module']); ?>&id=<?php echo $resultlists['id']; ?>','450px','auto');"><?php echo ucfirst($resultlists['serviceType']); ?></div>
                  </td>

                  <td width="3%" align="left">
                    <div><?php echo $resultlists['sacCode']; ?></div></td>
