  ...
  <table  width="100%" border="1" bordercolor="#dae5f0" cellpadding="2">
    <tbody>
      <tr>
        ...
        <td width="31%" style="height: 25px; font-size: 14px;"><span style="color:#000;">Invoice No: <strong><?php if($resultInvoice['invoiceType']=='2'){ echo $companyPAN['proformaInvoiceNoSequence'].'/'; } else { echo $companyPAN['taxInvoiceNoSequence'].'/'; } ?><?php echo makeInvoiceId($resultInvoice['id']); ?></strong></span></td>
