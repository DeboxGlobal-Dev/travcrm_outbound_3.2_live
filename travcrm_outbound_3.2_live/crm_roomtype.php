    ...
    <td width="91%" align="left" valign="top">
      ...
      <form id="listform" name="listform" method="get">
                ...
                <div class="headingm" style="margin-left:10px;"><span id="topheadingmain"><?php echo $pageName; ?></span>
                  ...
                  <div id="deactivatebtn" style="display:none;">
                    ...
                    <?php if ($deletepermission == 1) { ?>
                      ...
                      <input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Deactivate" onclick="masters_alertspopupopen('action=mastersdelete&name=RoomType','600px','auto');" />
              ...
              <td align="right">
                <table border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <?php if ($addpermission == 1) { ?><td style="padding-right:20px;"><input name="addnewuserbtn" type="button" class="bluembutton" id="addnewuserbtn" value="+ Add <?php echo "Room Type Name"; ?>" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&sectiontype=<?php echo clean($_GET['module']); ?>','400px','auto');" /></td> <?php } ?>
        ...
        <div id="pagelisterouter" style="padding-left:30px;">
          ...
          <input name="action" id="action" type="hidden" value="deleteroomtype" />
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-striped table-bordered" id="mainsectiontable">
            ...
            <thead>
              ...
              <tr>
                ...
                <th align="left" class="header">Room Type Name </th>
                <th align="left" class="header">Size </th>
                <th align="left" class="header">Maximum Occupancy </th>
                <th align="left" class="header">Bedding </th>
            ...
            <tbody>
              ...
              $rs = GetRecordList($select, _ROOM_TYPE_MASTER_, $where, $limit, $page, $targetpage);
              ...
              ?>
                ...
                <tr>
                  ...
                  <td width="11%" align="left">
                    <div class="bluelink" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&sectiontype=<?php echo clean($_GET['module']); ?>&id=<?php echo $resultlists['id']; ?>','400px','auto');"><?php echo $resultlists['size']; ?></div>
                  </td>
                  
                  <!-- adding two fields in room type master Maximum Occupancy and Bedding -->
                  <td width="11%" align="left">
                    <div class="bluelink" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&sectiontype=<?php echo clean($_GET['module']); ?>&id=<?php echo $resultlists['id']; ?>','400px','auto');"><?php echo $resultlists['maxoccupancy']; ?></div>
                  </td>
                  <td width="11%" align="left">
                    <div class="bluelink" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&sectiontype=<?php echo clean($_GET['module']); ?>&id=<?php echo $resultlists['id']; ?>','400px','auto');"><?php echo $resultlists['bedding']; ?></div>
                  </td>
