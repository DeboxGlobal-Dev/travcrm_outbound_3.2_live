...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Delete" onclick="masters_alertspopupopen('action=mastersdelete&name=holidayConfiguration','600px','auto');" />
	<?php } ?>
	</div>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
   ...
   <tr>
    ...
    <label for="checkAll"><span></span>&nbsp;</label></th> 
     ...
     <th align="left" class="header" >Valid untill</th>
...
$where='where name!="" and fileType=1 and deletestatus=0 order by id desc'; 
$page=$_GET['page'];
...
?>	</td>
	<td width="" align="left"><?php echo $resultlists['validUntill']; ?></td>
	<td align="left" ><a href="showpage.crm?module=hrmscompanyfile&view=yes&id=<?php echo encode($resultlists['id']); ?>"><input name="addnewuserbtn" type="button" class="bluembutton" value="View"/></a></td>
	</tr> 
