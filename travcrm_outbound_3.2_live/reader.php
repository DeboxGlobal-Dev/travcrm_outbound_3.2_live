...
class Spreadsheet_Excel_Reader
{
    ...
    function createDate_old($numValue)
    {
        if ($numValue > 1) {
    ...
    function createDate($numValue){
        if ($numValue > 1) {
            ...
            //echo $this->curformat; echo "<br>";dd/i/yyyy yyyy/i/dd
            if ($this->curformat == 'd/m/y' || $this->curformat == 'm/d/y' || $this->curformat == 'yyyy/mm/dd' || $this->curformat == 'dd/mm/yyyy' || $this->curformat == 'i/dd/yyyy' || $this->curformat == 'yyyy/i/dd'  || $this->curformat == 'dd/i/yyyy') {
