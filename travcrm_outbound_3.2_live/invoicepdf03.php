	...
	<table width="100%" border="1" cellpadding="3" bordercolor="#000000" style="border-collapse: collapse; border-top: 0px solid #fff;">
		<tbody>
			...
			<tr style="height: 15px;"> 
				...
				<td width="23%" style="font-size: 13px; text-align: right;"><strong><?php echo round(getChangeCurrencyValue_New($baseCurrencyId,$quotationId,$totalClientCost));?></strong></td>		
			</tr> 
			<tr>
