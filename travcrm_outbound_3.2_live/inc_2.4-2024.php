...
$pageTypeMaster = $editresultcsm['pageType'];
$hotelImportFormatType = $editresultcsm['hotelImportFormatType'];
...
$fullurl='http://localhost/DevOutbound_3.2/TravCRMExtension/travcrm-dev/';
