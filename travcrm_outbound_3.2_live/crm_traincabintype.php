...
<input name="action" id="action" type="hidden" value="deletetraincabintype" />
...
<th align="left" class="header" >Cabin Name</th> 
<th align="left" class="header" >Room Occupancy</th>
...
$rs=GetRecordList($select,_TRAIN_CABIN_TYPE_,$where,$limit,$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2]; 
while($resultlists=mysqli_fetch_array($rs[0])){ 
  ...
  <tr>
    ...
    <td width="20%" style="font-weight: 500;"><?php echo $resultlists['roomoccupancy']; ?> Room(s)</td>
