...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
   ...
   <tr>
    ...
    <label for="checkAll"><span></span>&nbsp;</label></th> 
     <th align="left" class="header" >Report Name</th>
...
$where='where name!="" and fileType=4 and deletestatus=0 order by id desc'; 
$page=$_GET['page'];
...
?>	</td>
	...
	<td width="" align="left"><?php echo $resultlists['dateFrom']; ?></td>
