                                ...
                                <div class="srch-tab-line">
                                    ...
                                    <div class="srch-tab">
                                        ...
                                        <div class="popup-date">
                                            ...
                                            <input type="text" id="fixdate" name="fixdate" class="popup-date-inner" autocomplete="off" placeholder="Fixed Date" value=""   readonly="">
                                    ...
                                    <div class="srch-tab">
                                        ...
                                        <div class="input-a">
                                            <input type="text" autocomplete="off" placeholder="Mobile/Contact Number" name="mobileNumber" id="mobileNumber" pattern="\d{3}[\-]\d{3}[\-]\d{4}" onKeyUp="phonevalidation123();">
                                            <span class="date-icon"></span>
                                        </div>
                                    </div>
                    ...
                    <div class="side-block fly-in" id="formright_1">
                        <div class="side-block-search">
                            <div class="page-search-p" style="padding-top:0;">
                                <div class="srch-tab-line">
                                    ...
                                    <div class="srch-tab">
                                        ...
                                        <ul class="list-inline list-checkbox margin-bottom-25 margin-left-25 options">
                                            ...
                                            <li>
                                                <input type="checkbox" name="hotelstars4" id="hotelstars4" value="4">
                                                <label for="hotel_catagory_4 Star">4 Star</label>
                                                <div class="sea-green text-center line-height-2"><small></small></div>
                                            </li>
                                            
                                            <li>
                                                <input type="checkbox" name="hotelstars3"  id="hotelstars3"value="3">
                                            ...
                                            <li>
                                                ...
                                                <li>
                                                    <input type="checkbox" name="hotelstars1" id="hotelstars1" value="1">
                                ...
                                <div class="srch-tab">
                                    <label id="airfare" style="float: left;">Expected Budget Without Airfare - </label><div class="personcost">&nbsp;(Per Person For Entire Trip)</div>
        ...
        $("#clickmeplanmyholidays").click(function(event){
            ...
            if(error_toDest == true && error_exploredesti == true && error_leavingForm == true && error_email == true && error_mobileNumber == true && error_fixdate == true && error_durationfilter == true && error_durationfilter == true){
                ...
                $.ajax({
                    ...
                    data:{toDest:toDest,exploredesti:exploredesti,bookmyticket:bookmyticket,leavingForm:leavingForm,fixdate:fixdate,flexibledate:flexibledate,anytimedate:anytimedate,email:email,mobileNumber:mobileNumber,durationfilter:durationfilter,fromDest:fromDest},
                    type:'post',
