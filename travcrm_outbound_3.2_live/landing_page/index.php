                            ...
                            <div class="page-search-p" style="padding-top:0;">
                                <div class="srch-tab-line">
                                    ...
                                    <div class="srch-tab" style="width: 225px;">
                                        <label for="leavingForm">From </label>
                                        <div class="">
                                            <select id="" name="fromDest" class="input-a" onChange="selectfromdest(this.value);">
                                    ...
                                    <div class="srch-tab" style="width: 225px; margin-left: 30px;">
                                        <label for="toDest">Going to<span style="color:#ff0000;"> *</span><span id="fromval" style="color:#ff0000; display: none;font-size: 12px;" >Please Select Destination</span></label>
                                        <div class="">
                                    ...
                                    <div class="srch-tab">
                                        <label for="fixdate">Departure Date <span style="color:#ff0000;"> *</span><span id="choosedate"  style="color:#ff0000; display: none; font-size: 12px; ">(Choose any Date)</span></label>
                                        <div class="popup-date">
                                            ...
                                            <input type="text" id="fixdate" name="fixdate" class="popup-date-inner" autocomplete="off" placeholder="Fixed Date" value=""   readonly="" style="background-image: url('images/Fixed-date-button.png'); background-color: white; height: 30px; width: 230px;background-repeat: no-repeat; background-size: cover; background-position: center;">
                                            ...
                                            <input type="text" id="anytimedate" name="anytimedate" class="popup-date-inner" autocomplete="off" placeholder="Anytime" value=""  readonly="" onClick="$('#bookmyticketshow').hide(); anytime();" style="background-image: url('images/Anytime-button.png'); background-color: white; height: 30px; width: 230px;background-repeat: no-repeat; background-size: cover;background-position: center;">
                                    ...
                                    <div class="srch-tab" style=" width: 150px;">
                                        <div class="input-a">
                                            <input type="text" autocomplete="off" placeholder="Name" name="nameNN" id="nameNN" style="font-size: 17px !important; color:#1c1c1c; padding:0px;">
                                            <span class="date-icon"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="srch-tab" style=" width: 150px; margin-left: 10px;">
                                        <div class="input-a">
                                            <input type="text" autocomplete="off" placeholder="Mobile" name="mobileNumber" id="mobileNumber" maxlength="10" pattern="\d{3}[\-]\d{3}[\-]\d{4}" onKeyUp="phonevalidation123();" style="font-size: 17px !important; color:#1c1c1c; padding:0px;">
                                            <span class="date-icon"></span>
                                        </div>
                                    </div>

                                    <div class="srch-tab" style="width: 180px; margin-left: 10px;">
                                        
                                        <div class="input-a">
                                            <input type="text" autocomplete="off" placeholder="Email" name="email" id="email" onKeyUp="emailvalidation123()" style="font-size: 17px !important; color:#1c1c1c; padding:0px;">
                                            <span class="date-icon"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="srch-tab" style="margin-top: 10px; width: 220px;" >
                                        ...
                                        <ul class="list-inline list-checkbox margin-bottom-25 margin-left-25 options">
                                            ...
                                            <li style="margin-left: 15px;"><input class="" type="radio" name="flight_requirement" value="0" id="flight_requirement_98" onChange="addAirfarefun(this);">&nbsp;&nbsp;<label for="flight_requirement_98"><b>No</b>&nbsp;
                                ...
                                $('#airfare').text('Expected Budget Without Airfare - ');
                                    ...
                                    <div class="srch-tab" style="margin-top: 10px;">
                                    <label>Number Of Adults<span style="color:#ff0000;"> *</span><br>
                                    <span id="adultchoose" style="color:#ff0000; display: none;font-size: 12px;" >Please Select Adult</span></label>
                                    <div class="no-of-childs-block-combo">
                                        <select class="input-a" name="adults" id="adults" style="box-shadow: none;color:#1c1c1c; border-radius: 2px;border-color: #b2b2b2;height: 34px;font-size: 15px;">
                                            ...
                                            <option value="" disabled="">Adults (12+ yrs)</option>
                                    ...
                                    <label style="margin-top: -25px; margin-left: 174px !important;">Number Of Childs</label>
                                    <div class="no-of-childs-block-combo">
                                    ...
                                    <div class="srch-tab" style="margin-left: 30px; width: 290px; margin-top: 10px;">
                                        ...
                                        <div class="">
                                            <input class="input-a" type="text" autocomplete="off" placeholder="* Planning to final in week time" name="yourmessage" id="yourmessage" style="height: 35px; font-size:15px; color:#1c1c1c;">    
                                            <span class="date-icon"></span>
                                        </div>
                                    </div>
                    ...
                    <div class="side-block-search">
                        <div class="page-search-p" style="padding-top:0;">
                            <div class="srch-tab-line">
                                ...
                                <div class="popup-first-button">
                                    <input type="button" class="popup-first-plan-button" id="submitfromdebox" value="Go To Home" onClick="window.location.href='//www.deboxglobal.com/landing_page/';">
                                </div>
...
<script type = "text/javascript" language = "javascript">
    $(document).ready(function() {
        $("#clickmeplanmyholidays").click(function(event){
            ...
            if(adults>0){
                $('#adultchoose').css('display','none');
                error_adults = true;
            } else{
                $('#adultchoose').css('display','block');
                error_adults = false;  
            }
            if(email!=""){
            ...
            if(error_toDest == true && error_exploredesti == true && error_leavingForm == true && error_email == true && error_mobileNumber == true && error_fixdate == true && error_durationfilter == true && error_durationfilter == true && error_adults == true){

                $.ajax({
                    url:"ajax_querydatasubmit.php",
                    data:{toDest:toDest,exploredesti:exploredesti,bookmyticket:bookmyticket,leavingForm:leavingForm,fixdate:fixdate,flexibledate:flexibledate,anytimedate:anytimedate,email:email,mobileNumber:mobileNumber,durationfilter:durationfilter,fromDest:fromDest,nameNN:nameNN,budget:budget,adults:adults,infant:infant,children:children,iwillbook:iwillbook,tot:tot,yourmessage:yourmessage,hotelCategory:hotelCategory,flight_requirement:flight_requirement},
                    type:'post',
