    ...
    <td width="91%" align="left" valign="top">
      <form id="listform" name="listform" method="get">
        <div class="rightsectionheader">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td>
                <div class="headingm" style="margin-left:10px;"><span id="topheadingmain"><?php echo "Hotel Additional Master"; ?></span>
                  <div id="deactivatebtn" style="display:none;">
                     <?php if ($deletepermission == 1) { ?>
                      <input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Deactivate" onclick="masters_alertspopupopen('action=mastersdelete&name=AdditionalHotel','600px','auto');" />
                    <?php } ?>
                  </div>
                </div>
              </td>
              <td align="right">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <?php if ($addpermission == 1) { ?><td style="padding-right:20px;"><input name="addnewuserbtn" type="button" class="bluembutton" id="addnewuserbtn" value="+ Add <?php echo "Additional"; ?>" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&sectiontype=<?php echo clean($_GET['module']); ?>','400px','auto');" /></td> <?php } ?>
        ...
        <div id="pagelisterouter" style="padding-left:30px;">
          ...
          <input name="action" id="action" type="hidden" value="deleteAdditionalHotel" />
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-striped table-bordered" id="mainsectiontable">
            ...
            <tbody>
              ...
              $rs = GetRecordList($select,'additionalHotelMaster', $where, $limit, $page, $targetpage);
              ...
              ?>
                ...
                <tr>
                  ...
                  <td width="2%" align="center" valign="middle"><?php if ($editpermission == 1) { ?><input type="checkbox" id="c<?php echo $no; ?>" name="check_list[]" class="chk" value="<?php echo encode($resultlists['id']); ?>" />
                    ...
                    <td width="11%" align="center"><?php if($resultlists['image']==''){
                        ...
                        ?>
                        <img src="packageimages/<?php echo $resultlists['image'] ?>" alt="" style="width:120px; margin:auto;">
                        <?php
                    } ?>
                        </td>
                  <td width="11%" align="left">
                    ...
                    <td width="11%" align="left"><?php echo clean($resultlists['detail']) ?></td>
