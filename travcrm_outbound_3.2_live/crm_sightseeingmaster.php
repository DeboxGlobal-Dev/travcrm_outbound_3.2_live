...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Delete" onclick="masters_alertspopupopen('action=mastersdelete&name=Sightseeing','600px','auto');" />
	<?php } ?>
	</div>
    ...
    <td align="right"><table border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <?php if($addpermission==1){ ?>
			<td  ><input name="addnewuserbtn" type="button" class="bluembutton" id="importbutton" value="Import"  /></td>
		<td style="padding-right:20px;"><input name="addnewuserbtn" type="button" class="bluembutton" id="addnewuserbtn" value="+ Add New <?php echo $pageName; ?>" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&sectiontype=<?php echo clean($_GET['module']); ?>','400px','auto');" /></td> <?php } ?>
      </tr>
...
<input name="action" id="action" type="hidden" value="deletesightseeingmaster" />
...
$rs=GetRecordList($select,_SIGHTSEEING_MASTER_MASTER_,$where,$limit,$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2]; 
...
<div class="pagingdiv">
 ...
 <input name="importsightseeingmasterexcel" id="importsightseeingmasterexcel" type="hidden" value="Y" /> <input name="importpackagesightseeingModule" id="importpackagesightseeingModule" type="hidden" value="<?php echo clean($_GET['module']); ?>" />
