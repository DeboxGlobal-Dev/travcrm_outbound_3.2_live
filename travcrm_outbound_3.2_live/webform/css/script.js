...
$(document).ready(function(){
	...
	$slideHover = function() {
		$('.offer-slider-i').on({
			mouseenter: function(){
				...
				$(this).find('.offer-slider-btn').animate({top: "60%"}, 170);
			},
			mouseleave: function(){
	...
	$headerUp = function() {
		...
		$('.header-b').css('height','70px');
		$('.header-logo').css('margin-top','26px');
		$('.header-right').css('margin-top','30px');
		$('.header-logo').find('img').attr('src','images/logo.png');
	}
	...
	$('body').click(function(){
		$('.overlay').fadeIn(function(){
			$('.autorize-popup').animate({top: '60%'}, 300);
		});
		return false;
	});
...
/*		$('body').scroll(function(){
			alert('hello');
		$('.overlay').fadeIn(function(){
			$('.autorize-popup').animate({top: '50%'}, 300);
		});
		return false;
	});*/
