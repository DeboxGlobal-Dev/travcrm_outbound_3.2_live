...
<html lang="en">
    ...
    overflow-x: hidden;
    height: 100%;
    background-image: url("images/webformbackgroung.jpg");
	...
	<div class="griddiv">
		...
		<select id="clientType" name="clientType" class="gridfield validate" displayname="Client Type" autocomplete="off">
			...
			<?php } ?>
                                    ...
                                    <div class="no-of-childs-block-combo" style="width: 200px;">
                                    ...
                                    <div class="srch-tab" style=" width: 50px; margin-left: 10px;">
                                        <div class="input-a">
                                    ...
                                    <div class="srch-tab" style=" width: 150px; margin-left: 10px;">
                                        <div class="input-a">
                                            <input type="text" autocomplete="off" placeholder="Mobile" name="mobileNumber" id="mobileNumber" pattern="\d{3}[\-]\d{3}[\-]\d{4}" onKeyUp="phonevalidation123();" style="font-size: 17px !important; color:#1c1c1c; padding:0px;" maxlength="10">
                                            <span class="date-icon"></span>
                                        </div>
                                    </div>

                                    <div class="srch-tab" style="width: 270px; margin-left: 10px;">
                                        
                                        <div class="input-a">
                                            <input type="text" autocomplete="off" placeholder="Email ID" name="email" id="email" onKeyUp="emailvalidation123()" style="font-size: 17px !important; color:#1c1c1c; padding:0px;">
                                            <span class="date-icon"></span>
                                        </div>
                                    </div>
                                ...
                                <!-- sec room started -->
                                <div class="srch-tab" style="margin-top: 15px;">
                                ...
                                $('#airfare').text('Expected Budget Without Airfare - ');
                                    ...
                                    <div class="srch-tab" style="position: relative;top: -79px; left: 217px;">
                                    ...
                                    <div class="popup-first-button" style="width: 60%;">
                                        <input type="button" class="popup-first-plan-button" id="clickmeplanmyholidays" name="clickmeplanmyholidays" value="Submit Query" style="cursor:pointer;">
                            ...
                            <div class="page-search-p" style="padding-top:0;">
                                <div class="srch-tab-line">
                                    ...
                                    <div class="popup-first-button">
                                        <input type="button" class="popup-first-plan-button" id="submitfromdebox" value="Go To Home" onClick="window.location.href='<?php echo $fullurl; ?>webform/';">
                                    </div>
