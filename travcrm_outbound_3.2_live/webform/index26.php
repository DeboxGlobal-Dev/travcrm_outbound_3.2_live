                 ...
                 <div class="page-search-p" style="padding-top:0;">
                    <div class="srch-tab-line">
                       <div class="srch-tab">
                          ...
                          <div class="input-a">
                            <!--  <Select class="input-a" name="country" 
                             id="country" style="box-shadow: none;color: #4f4f4f; border-radius: 2px;border-color: #b2b2b2;height: 34px;font-size: 13px;width:99% !important;">
                       ...
                       <div class="srch-tab">
                          ...
                          <div class="input-a">
                             <input type="text" autocomplete="off" placeholder="Leaving from" name="leavingForm" id="leavingForm">
                       ...
                       <div class="srch-tab">
                          <label>Depature Date <span style="font-size: 12px;font-weight: 400;">(Choose any)</span></label>
...
$(".popup-date-inner").addClass('popupdateinnernew');
  ...
  $("#resetbtndiv").show();
          ...
          <a onClick="resetbuttons();$('#resetbtndiv').hide();$('.popup-date-inner').removeClass('popupdateinnernew');" id="resetbtndiv" style="display: none;" class="xbtn">x</a>
                             ...
                             <input type="text" id="anytimedate" name="anytimedate" class="popup-date-inner" autocomplete="off" placeholder="Anytime" value="Anytime" onClick="anytime();" readonly="" onClick="$("#bookmyticketshow").hide();">
              ...
              <!--<label>Week :</label> <span id="startDate"></span> - <span id="endDate"></span>-->
               ...
               $('#durationfilter').val(totalduration)
                       ...
                       <div class="srch-tab">
                          ...
                          <div class="input-a">
                             <input type="text" autocomplete="off" placeholder="Mobile/Contact Number" name="mobileNumber" id="mobileNumber">
                             <span class="date-icon"></span>
                          </div>
                       </div>
              ...
              <div class="side-block-search">
                 <div class="page-search-p" style="padding-top:0;">
                    <div class="srch-tab-line">
                      ...
                      <div class="srch-tab">
                          <label>Preferred Hotel Category (Rating)<span style="color:#ff0000;"> *</span></label>
     ...
     $(document).ready(function() {
        ...
        $("#submitfromdebox").click(function(event){
          ...
          var bookmyticket=$("#bookmyticket").val();
           ...
           data:{country:country,exploredesti:exploredesti,leavingForm:leavingForm,fixdate:fixdate,flexibledate:flexibledate,anytimedate:anytimedate,email:email,mobileNumber:mobileNumber,hotelstars:hotelstars,flight_requirement:flight_requirement,budget:budget,adults:adults,infant:infant,children:children,iwillbook:iwillbook,flight_requirement_97:flight_requirement_97,tot:tot,yourmessage:yourmessage,durationfilter:durationfilter,bookmyticket:bookmyticket},
           type:'post',
