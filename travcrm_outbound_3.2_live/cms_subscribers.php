			...
			<div id="pagelisterouter" style="padding-left:30px;">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
				   ...
				   <tr>
						...
						<th  align="left" class="header" >Subscribed Date</th>
				  ...
				  <?php
					...
					$where='where type="subscribe_form" order by id desc'; 
					$page=$_GET['page'];
				  ...
				  <tr>
					...
					<td width="10%" align="left"> <?php echo date('t M Y', strtotime($dateAdded)); ?> </td>
					<td width="11%" align="left">
						<a href="?module=cms&amp;page=<?php echo $_REQUEST['page'];?>&amp;id=<?php echo $resultlists['id']; ?>&amp;action=del" 
							onclick="return cmd_del()"><img src="images/dlt.png" alt="Delete" width="30" height="32" border="0" /> 
						</a>
					</td>
				  </tr>
					<?php $no++; } ?>
