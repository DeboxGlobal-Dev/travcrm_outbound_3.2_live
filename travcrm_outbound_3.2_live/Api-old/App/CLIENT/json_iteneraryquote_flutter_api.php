...
// $fullurl.'tcpdf/examples/genrateitinerarypdf.php?pageurl='.
...
<?php } ?>
		...
		"ServiceImage" : "",
		"ServiceTypeName": "<?php echo ucwords(strtolower($DayWiseData['ServiceName'])); ?>",
		...
		"StartTime": "<?php echo date('h:i:s A',strtotime($DayWiseData['StartTime'])); ?>",
		"EndTime": "<?php echo date('h:i:s A',strtotime($DayWiseData['EndTime'])); ?>",
