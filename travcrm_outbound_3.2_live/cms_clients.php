...
<input name="action" id="action" type="hidden" value="ramaclients" />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
  ...
  <tbody>
    ...
    $where='where type="clients" order by id desc'; 
    $page=$_GET['page'];
  ...
  <tr>
    ...
    <td width="15%" align="left"><div class="bluelink" onclick="cms_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&page=<?php echo clean($_GET['page']); ?>&id=<?php echo $resultlists['id']; ?>','800px','auto');" ><?php echo $resultlists['title']; ?></div>   </td>
...
<?php
	...
	<td width="18%" align="left"><?php if($resultlists['image1']!=''){ ?><img src="<?php echo $fullurl; ?><?php echo $resultlists['image1']; ?>" height="100" /><?php }else{ }  ?></td>
	<td width="10%" align="center"><?php if($resultlists['status']==1){ ?>
        <a href="showpage.crm?module=cms&page=clients&amp;status=0&amp;id=<?php echo $resultlists['id']; ?>"> <img src="images/unlock.png" width="30" border="0" /> </a>
        <?php } else { ?>
        <a href="showpage.crm?module=cms&page=clients&amp;status=1&amp;id=<?php echo $resultlists['id']; ?>"> <img src="images/lock.png" /> </a>
        <?php } ?>
    </td>
    
    <td width="5%" align="center">
      <div class="bluelink" onclick="cms_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&page=<?php echo clean($_GET['page']); ?>&id=<?php echo $resultlists['id']; ?>','800px','auto');" ><img src="images/edit_icon.png" alt="Edit" width="25" border="0" />
      </div>
    </td>

    <td width="9%" align="center">
      <a href="?module=cms&amp;page=clients&amp;id=<?php echo $resultlists['id']; ?>&amp;action=del" onclick="return cmd_del()"> 
