...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<input name="deactivate" type="button" class="redmbutton" id="deactivate" value="  Deactivate  " onclick="masters_alertspopupopen('action=mastersdelete&name=expense-Head','600px','auto');" />
	<?php } ?>
	</div>
...
<input name="action" id="action" type="hidden" value="deleteExpenseHead" />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-striped table-bordered" id="mainsectiontable">
   ...
   <tr>
    ...
    <!--<label for="checkAll"><span></span>&nbsp;</label></th>-->
     ...
     <th align="left" class="header" >Head Name </th>
...
$rs=GetRecordList($select,'expenseHeadMaster',$where,$limit,$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2]; 
