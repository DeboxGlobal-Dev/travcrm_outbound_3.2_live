...
<div id="pagelisterouter" style="padding-left:0px;">
 ...
 <div class="addeditpagebox vieweditpagebox">
  ...
  <tr>
	...
	<div class="griddiv"><label><div class="gridlable">Next Follow Up Date</div>
	<div class="gridtext" style="text-transform:uppercase;"><?php echo $editresult['followupdate']; ?></div>
	 
	</label>
	</div>
	
 
	 <div class="griddiv"><label><div class="gridlable">Meeting Outcome</div>
...
<?php echo getUserName($editresult['assignTo']); ?></div>
	 </label>
	</div>
...
if($editresult['campaign']!=''){
$select12='*';  
$where12='id='.$editresult['campaign'].''; 
$rs12=GetPageRecord($select12,_CAMPAIN_MASTER_,$where12); 
$calltype=mysqli_fetch_array($rs12); 
echo $calltype['name'];
}
?></div>
...
$rs12=GetPageRecord('name','leadssourceMaster','1 and id="'.$editresult['leadsource'].'"'); 
$calltype=mysqli_fetch_array($rs12); 
echo $calltype['name'];
}
?></div>
