        ...
        <div class="rightsectionheader">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td>
                <div class="headingm" style="margin-left:30px;"><span id="topheadingmain"><?php echo 'Amenities Master'; ?></span>
                  <div id="deactivatebtn" style="display:none;">
                    <?php if ($deletepermission == 1) { ?>

                      <input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Deactivate" onclick="masters_alertspopupopen('action=mastersdelete&name=Amenities','600px','auto');" />
                    <?php } ?>
                  </div>
              ...
              <?php if ($addpermission == 1) { ?><td style="padding-right:20px;"><input name="addnewuserbtn" type="button" class="bluembutton" id="addnewuserbtn" value="+ Add New <?php echo 'Amenity'; ?>" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&sectiontype=<?php echo clean($_GET['module']); ?>','400px','auto');" /></td> <?php } ?>
            </tr>
...
<div id="pagelisterouter" style="padding-left:30px;">
  <input name="action" id="action" type="hidden" value="deleteamenities" />
  <input name="module" id="module" type="hidden" value="<?php echo clean($_GET['module']); ?>" />

  <table width="100%" border="1" bordercolor="#e8e8e8" cellpadding="0" cellspacing="0" class="tablesorter gridtable">

    <thead>

      <tr>
        <th width="4%" valign="middle" class="header">SN</th>
        ...
        <th align="center" class="header">Amenity Image </th>
    ...
    <tbody>
      ...
      $rs = GetRecordList($select, _AMENITIES_MASTER_, $where, $limit, $page, $targetpage);
      $totalentry = $rs[1];
      $paging = $rs[2];
      ...
      ?>
        <tr>
          <td><?php echo $no ?><?php if($resultlists['defaultAmenity']==1){ ?><div style="background: green;width: fit-content;padding: 4px;color: white;border-radius: 2px;font-size: 9px;"><i class="fa fa-cog" aria-hidden="true"></i> Default</div><?php  } ?></td>
          ...
          <td align="center"><?php if($resultlists['image']==''){
                        echo "<div style='background:#ccc; font-size: 15px;width: 73px; text-align: center; padding: 29px 25px;border-radius: 2px; margin:auto;'>No Image</div>;";
                    }else{
                        ?>
              <img src="packageimages/<?php echo $resultlists['image'] ?>" alt="Amenity Image" width="120px">
              <?php } ?>
          </td>
          <td align="left">
          ...
          <td width="8%" align="center"><?php if ($resultlists['status'] == 1) { ?><div style=" width: fit-content; color: green; "><?php echo 'Active'; ?></div><?php } else { ?><div style=" width: fit-content; color: red; "><?php echo 'In Active'; ?></div><?php }  ?>
