...
<div style="padding-bottom:10px; margin-bottom:10px; border-bottom:2px solid #ccc;  text-align:left;">
 ...
 <div style="padding-bottom:10px; margin-bottom:10px; text-align:center; font-size:22px; padding-top:10px; text-align:left; text-align:center; text-transform:uppercase;">Remittance Invoice</div>
...
Phone: <?php echo getPrimaryPhone($resultCompany['id'],''.$mobilemailtype.''); ?>
    ...
    height: 150px;
    line-height: 21px;
    font-size: 12px;"><strong><?php echo stripslashes($resultInvoiceSetting['recompanyname']); ?></strong>  <br />
        <br />
<?php echo nl2br($resultInvoiceSetting['readdress']); ?><br />
	</div></td>
  </tr>
...
<div style="     padding: 10px;
   ...
   <tr>
      ...
      <th align="right" class="header" style="border-bottom: 2px #e8e8e8 solid;">Remtt&nbsp;Charges</th>
      <?php 
$select=''; 
$where=''; 
$rs='';  
...
echo 'INR';
    ...
    <td align="right" style="border-bottom: 1px #e8e8e8 solid;"><?php  echo  ($dmcroommastermain['rate'])*$curvalue; ?></td>
    <td align="right"  style="border-bottom: 1px #e8e8e8 solid;"><?php  echo  ($dmcroommastermain['remcharges'])*$curvalue; ?></td>
    <?php 
$select=''; 
$where=''; 
$rs='';  
...
?>
    <?php  } ?>
    <td align="right" style="style="border-bottom: 1px #e8e8e8 solid;""><?php $totalsub=$dmcroommastermain['rate']*$dmcroommastermain['pax']; $totalsubgst=$dmcroommastermain['remcharges']; echo  ($totalsub+$totalsubgst)*$curvalue; ?></td>
    </tr>	<?php  $s++; } ?>
</tbody></table>
...
$number = $t*$curvalue;
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td bgcolor="#FFFFFF"><?php echo stripslashes($resultInvoiceSetting['repolicies']); ?></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ecedf1">
      <tbody>
        ...
        <tr>
          ...
          <td width="30%" align="right" bgcolor="#FFFFFF"><strong>For <?php echo stripslashes($resultInvoiceSetting['recompanyname']); ?></strong></td>
        </tr>
        <tr>
