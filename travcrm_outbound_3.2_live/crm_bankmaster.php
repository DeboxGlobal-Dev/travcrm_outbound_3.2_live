...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <!--<td >
	...
	<input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Deactivate" onclick="masters_alertspopupopen('action=bankdelete&name=Bank','600px','auto');" />
	<?php } ?>
	</div>
    ...
    <td align="right"><table border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td><input name="keyword" type="text" class="topsearchfiledmain" id="keyword" style="width:150px;" value="<?php if(isset($_GET['keyword'])){echo $_GET['keyword']; } ?>
" size="100" maxlength="100" placeholder="Keyword"></td>
...
<input name="action" id="action" type="hidden" value="deletebank" />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-striped table-bordered" id="mainsectiontable">
   ...
   <tr>
    ...
    <label for="checkAll"><span></span>&nbsp;</label></th> 
     ...
     <th align="left" class="header" >Account Type </th>
     <th align="left" class="header" >Account Number </th>
	 <th  align="left" class="header" >Beneficiary Name </th>
...
if($_GET['keyword']!=''){
$wheresearch="and bankName like '%".$_GET['keyword']."%'";
...
$where='where  bankName!=""  '.$wheresearch2.' '.$wheresearch.' and deletestatus=0  order by bankName asc'; 
...
$rs=GetRecordList($select,'bankMaster',$where,$limit,$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2]; 
...
?>
  <tr>
    <td width="1%" align="left"><?= $no; ?><?php if($resultlists['setDefault']==1){ ?><div style="background: green;width: fit-content;padding: 4px;color: white;border-radius: 2px;font-size: 9px;"><i class="fa fa-cog" aria-hidden="true"></i> Default</div><?php  } ?></td>
    ...
    <td width="8%" align="left"><div class="bluelink" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&sectiontype=<?php echo clean($_GET['module']); ?>&id=<?php echo $resultlists['id']; ?>','600px','auto');" ><?php echo $resultlists['bankName']; ?></div>   </td>
	
	<td width="3%" align="left"><div><?php echo $resultlists['accountType']; ?></div>
	<td width="3%" align="left"><div><?php echo $resultlists['accountNumber']; ?></div>
	<td width="3%" align="left"><div><?php echo $resultlists['beneficiaryName']; ?></div>
	<td width="3%" align="left"><div><?php echo $resultlists['branchIFSC']; ?></div>
	<td width="3%" align="left"><div><?php echo $resultlists['branchAddress']; ?></div>
	</td>

	<td width="8%" align="left"><?php $select=''; 
$where2=''; 
$rs2='';  
...
<?php
	...
	<td width="2%" align="left"><?php if($resultlists['status']==1){?><div style=" width: fit-content; color: green;"><?php echo 'Active';?></div><?php } else { ?><div style=" width: fit-content; color: red; "><?php echo 'In Active';?></div><?php }  ?>
	</td>
	</tr> 
