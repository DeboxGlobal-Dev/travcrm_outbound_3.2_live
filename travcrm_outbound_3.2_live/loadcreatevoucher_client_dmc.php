...
<div class="main-container">
    <div class="sub-container" style="border:1px dashed #ddd;padding:20px;font-size: 13px;" id="mailSectionArea">
     ...
     <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top: 10px;">
		<tr>
		    <td align="center"><img src="<?php echo $fullurl; ?>dirfiles/<?php echo $masterProposalLogo; ?>" style="width:700px;height:100px; margin: 0 auto;" /></td>
        </tr>
	 </table>
...
<!-- ===================== Supplier related information ====================== -->
    <form action="final_frmaction.php" method="post" name="addDMCvouhcher" target="actoinfrm" id="addDMCvouhcher">
                ...
                <tr>
                    <td width="60%" align="left">
                        <table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <p style="width:90%;text-align: left;"> <?php echo $agentAddress; ?></p>
                    ...
                    <td width="40%" align="right">
                        <table width="100%" cellpadding="0" cellspacing="0" >
                            <tr> <td align="right"> <strong>Tour ID :</strong> <?php echo $tourId; ?></td></tr>
                            <tr><td align="right"> <strong>Voucher No.:</strong> <?php echo $showVocherNum; ?></td></tr>
                            <tr><td align="right"> <strong>Voucher Date :</strong> <?php echo $voucherDate; ?></td></tr>
                        </table>
                    </td>
                </tr>
            </table>
        ...
        <div class="flightTrainMode">
                    ...
                    <input style="width: 100%;" type="hidden" name="EditselModeId" id="EditselModeId" 
                        value="<?php echo $dmcmodedetails['id']?>">
            <div class="selectboxmode">
                
                <!--dropdown list options-->
                <select id="selectboxmodebox" name="selectboxmodebox" onchange="modeselect()">
                    <option>Select Mode</option>
                    <option value="surface" <?php if($modeType=='surface'){ ?>selected="selected" onchange="modeselect()" <?php } ?>>Surface</option>
                    <option value="flight" <?php if($modeType=='flight'){ ?>selected="selected" onchange="modeselect()"<?php } ?>>Flight</option>
                    <option value="train" <?php if($modeType=='train'){ ?>selected="selected" onchange="modeselect()"<?php } ?>>Train</option>
            ...
            <!-- arrivel info start -->
             ...
             <!-- surface -->
            <div id="surface" class="surface box1" style="background: none;">
                
            <div ><h3 class="traveller-dt-s" style="padding: 6px 5px; background-color: #acc5ef;font-size: 16px;font-weight: 500;color:black;">Arrival Information Surface</h3></div>
               
                <table width="100%" border="1" bordercolor="#cecece" cellpadding="10" cellspacing="0" class="tbl-tdate" style="background: #e7ebec;color:black;">
                    ...
                    <tr style="background: white;">
                        ...
                        <td align="left">
                            ...
                            <!-- <input style="width: 100%;" type="hidden" name="mafts_type_dmc" id="mafts_type_dmc" value="surface"> -->
                        </td>
            ...
            <div class="flight box1" style="background: none!important;"> 
                <div ><h3 class="traveller-dt-s" style="padding: 6px 5px; background-color: #acc5ef;font-size: 16px;font-weight: 500;color:black;">Arrival Information Flight</h3></div>
                ...
                <table width="100%" border="1" bordercolor="#cecece" cellpadding="10" cellspacing="0" class="tbl-tdate" style="background: #e7ebec;color:black;">
                    ...
                    <tr style="background: white;">
                        ...
                        <td align="left">
                            ...
                            <!-- <input style="width: 100%;" type="hidden" name="mafts_type_dmc" id="mafts_type_dmc" value="flight"> -->
                        </td>
            ...
            <div ><h3 class="traveller-dt-s" style="padding: 6px 5px; background-color: #acc5ef;font-size: 16px;font-weight: 500;color:black;">Arrival Information Train</h3></div>
               ...
               <table width="100%" border="1" bordercolor="#cecece" cellpadding="10" cellspacing="0" class="tbl-tdate" style="background: #e7ebec;color:black;">
                   ...
                   <tr style="background: white;">
                       ...
                       <td align="left">
                           ...
                           <!-- <input style="width: 100%;" type="hidden" name="mafts_type_dmc" id="mafts_type_dmc" value="train"> -->
                       </td>
        ...
        <?php
        $rsG = GetPageRecord('*','contactsMaster',' queryId2="'.$queryId.'" and tourId="'.$tourId.'" and contactType=3 ');
        ...
        <table width="100%" border="1" bordercolor="#cecece" cellpadding="10" cellspacing="0" class="travle-details-tdate">
            <div ><h3 class="traveller-dt-s" style="padding: 6px 5px; background-color: #acc5ef;font-size: 16px;font-weight: 500;">Traveller Detail</h3></div>
                <tr class="trav-dt-ss1" style="background-color: #f4f4f4;">
                    <th align="left" width="20">Srn.</th>
                    <th align="left" width="300">Name</th>
                    <th align="left" width="200">Gender</th>
                ...
                <td align="left">
                    <?php 
                    if($guestData['leadpaxstatus']=='1'){ 
                        $lead = "Lead Pax"; ?><strong> <?php  echo $lead ?></strong> <?php echo $guestData['firstName'].' '.$guestData['middleName'].' '.$guestData['lastName']; 
                    }else{
        ...
        <table border="1" bordercolor="#cecece" cellpadding="5" cellspacing="0" class="accommodation-details-tdate">
            ...
            <tr class="trav-dt-ss1" style="background-color: #f4f4f4;">
                ...
                <th width="10%" align="left">Room</th>
        ...
        <div class="tours-tranfer-details-sec">
            <table width="100%" border="1" bordercolor="#cecece" cellpadding="5" cellspacing="0" class="tours-tranfer-details-tdate">
                <div class="tours-tranfer-dt-s"><h3 class="heading-dt-s" style="padding: 6px 5px; background-color: #acc5ef;font-size: 16px;font-weight: 500;">Tours & Transfers</h3></div>
                <tr class="trav-dt-ss1" style="background-color: #f4f4f4; font-size:14px;">
                    ...
                    <th width="15%" align="left">Pickup&nbsp;Address</th>
                    <th width="15%" align="left">Drop&nbsp;Adress</th>
                ...
                <tr>
                    ...
                    <input type="hidden" name="tpttimeId<?php echo $entN; ?>" id="tpttimeId<?php echo $entN; ?>" value="<?php echo $tptTime['id']; ?>">

                    <input type="hidden" name="tptAction" id="tptAction" value="transferServices">
                    

                    <input type="hidden" name="tptquoteId<?php echo $entN; ?>" id="tptquoteId<?php echo $entN; ?>" value="<?php echo $finalQuoteTPT['transferQuotationId']; ?>">

                    <td align="left"><input type="text" class="end_start_td flighttimepicker2" name="pickupTime<?php echo $entN; ?>" id="pickupTime<?php echo $entN; ?>" value="<?php echo $pickupTime; ?>" data-time-format="H:i" placeholder="00:00" data-step="5" data-min-time="12:00" data-max-time="11:59"  data-show-2400="true"></td>

                    <td align="left"><input type="text" class="end_start_td flighttimepicker2" name="dropTime<?php echo $entN; ?>" id="dropTime<?php echo $entN; ?>" value="<?php echo $dropTime; ?>" data-time-format="H:i" placeholder="00:00" data-step="5" data-min-time="12:00" data-max-time="11:59"  data-show-2400="true"></td>

                    <td align="left">
                    <input type="text" class="end_start_td tptWidth" name="pickupAddress<?php echo $entN; ?>" id="pickupAddress<?php echo $entN; ?>" value="<?php echo $tptTime['pickupAddress']; ?>" >
                    </td>

                    <td align="left">
                    
                        <input type="text" class="end_start_td tptWidth" name="dropAddress<?php echo $entN; ?>" id="dropAddress<?php echo $entN; ?>" value="<?php echo $tptTime['dropAddress']; ?>" >
                    </td>
                    ...
                    <input type="hidden" name="tptNum" id="tptNum" value="<?php echo $entN; ?>">
      ...
      <?php 
        ...
        <div class="excursion-ticket-details-sec">
            <table width="100%" border="1" bordercolor="#cecece" cellpadding="5" cellspacing="0"  class="excursion-ticket-details-tdate">
                <div class="excursion-ticket-dt-s"><h3 class="heading-dt-s" style="padding: 6px 5px; background-color: #acc5ef;font-size: 16px;font-weight: 500;">Excursions & Tickets</h3></div>
                <tr class="trav-dt-ss1" style="background-color: #f4f4f4;">
            ...
            if($entranceData['transferType'] == 1){
                $transferType = 'SIC';
             }elseif($entranceData['transferType'] == 2){
                $transferType = 'PVT';
             }if($entranceData['transferType'] == 3){
        ...
        // } 
             ?>
                <tr>
                    <td align="left"><?php echo $transferType.' | '.$entranceDData['entranceName']; ?></td>

                    <input type="hidden" name="entAction" id="entAction" value="entranceServices">

                    <input type="hidden" name="entranceTimeId<?php echo $entN; ?>" id="entranceTimeId<?php echo $entN; ?>" value="<?php echo $entranceTime['id']; ?>">

                    <input type="hidden" name="entranceQuoteId<?php echo $entN; ?>" id="entranceQuoteId<?php echo $entN; ?>" value="<?php echo $entranceData['entranceQuotationId']; ?>">

                    <td align="left"> <input type="text" class="end_start_td flighttimepicker2" name="entStartTime<?php echo $entN; ?>" id="entStartTime<?php echo $entN; ?>" value="<?php echo $startTime; ?>" data-time-format="H:i" placeholder="00:00" data-step="5" data-min-time="12:00" data-max-time="11:59"  data-show-2400="true"></td>
                    
                    <td align="left"> <input type="text" class="end_start_td flighttimepicker2" name="entEndTime<?php echo $entN; ?>" id="entEndTime<?php echo $entN; ?>" value="<?php echo $endTime ; ?>" data-time-format="H:i" placeholder="00:00" data-step="5" data-min-time="12:00" data-max-time="11:59"  data-show-2400="true"></td>

                    <td align="left"> <input type="text" class="end_start_td flighttimepicker2" name="entraPickupTime<?php echo $entN; ?>" id="entPickupTime<?php echo $entN; ?>" value="<?php echo $pickupTime; ?>" data-time-format="H:i" placeholder="00:00" data-step="5" data-min-time="12:00" data-max-time="11:59"  data-show-2400="true"></td>

                    <td align="left"> <input type="text" class="end_start_td flighttimepicker2" name="entraDropTime<?php echo $entN; ?>" id="entDropTime<?php echo $entN; ?>" value="<?php echo $dropTime; ?>" data-time-format="H:i" placeholder="00:00" data-step="5" data-min-time="12:00" data-max-time="11:59"  data-show-2400="true"></td>
                    
                    <td align="left"><input type="text" class="end_start_td tptWidth" name="entpickupAddress<?php echo $entN; ?>" id="entpickupAddress<?php echo $entN; ?>" value="<?php echo $entranceTime['pickupAddress']; ?>" style="width: 100%;"> </td>

                    <td align="left"><input type="text" class="end_start_td tptWidth" name="entdropAddress<?php echo $entN; ?>" id="entdropAddress<?php echo $entN; ?>" value="<?php echo $entranceTime['dropAddress']; ?>" style="width: 100%;"> </td>
            ...
            $entN++;
                ...
                <input type="hidden" name="entNum" id="entNum" value="<?php echo $entN; ?>">
            </table>
            <?php 
            $entN = 0;
            $activityQQuery='';    
            ...
            if($activityTime['endTime']!='00:00:00' && $activityTime['endTime']!=''){
                $endTime = date('H:i',strtotime($activityTime['endTime']));
            }else{
                $endTime='';
            }

            if($activityTime['startTime']!='00:00:00' && $activityTime['startTime']!=''){
                $startTime = date('H:i',strtotime($activityTime['startTime']));
            }else{
                $startTime='';
            }
            ...
            if($activityData['transferType'] == 1){
                ...
                $transferType = 'VIP';
             }if($activityData['transferType'] == 4){
                $transferType = 'Ticket Only';
             }

             ?>
                <tr>
                    <input type="hidden" name="actAction" id="actAction" value="activityServices">
                    <input type="hidden" name="activityTimeId<?php echo $entN; ?>" id="activityTimeId<?php echo $entN; ?>" value="<?php echo $activityTime['id']; ?>">

                    <input type="hidden" name="activityQuoteId<?php echo $entN; ?>" id="activityQuoteId<?php echo $entN; ?>" value="<?php echo $activityData['activityQuotationId']; ?>">

                    <td align="left"><?php echo $transferType.' | '. $activityDData['otherActivityName']; ?></td>
                 
                    <td align="left"><input type="text" class="end_start_td timepicker2" name="actStartTime<?php echo $entN; ?>" id="actStartTime<?php echo $entN; ?>" value="<?php echo $startTime ; ?>" data-time-format="H:i" placeholder="00:00" data-step="5" data-min-time="12:00" data-max-time="11:59"  data-show-2400="true"></td>

                    <td align="left"><input type="text" class="end_start_td timepicker2" name="actEndTime<?php echo $entN; ?>" id="actEndTime<?php echo $entN; ?>" value="<?php echo $endTime ; ?>" data-time-format="H:i" placeholder="00:00" data-step="5" data-min-time="12:00" data-max-time="11:59"  data-show-2400="true"></td>

                    <td align="left"><?php echo $activityData['confirmationNo']; ?></td>
                </tr>
             <?php $entN++; } ?>
             <input type="hidden" name="actNum" id="actNum" value="<?php echo $entN; ?>">
        ...
        <table width="100%" border="1" bordercolor="#cecece" cellpadding="5" cellspacing="0" class="flight-train-details-tdate">
                <div class="flight-train-dt-s"><h3 class="heading-dt-s" style="padding: 6px 5px; background-color: #acc5ef;font-size: 16px;font-weight: 500;">Flight & Train</h3></div>
               <thead>
                <tr class="trav-dt-ss1" style="background-color: #f4f4f4;">
                    <th width="5%" align="left">Type</th>
                ...
                if($timeData['departureDate']!='' && $timeData['departureDate']!='00-00-00'){
                   $departureDate = date('Y-m-d',strtotime($timeData['departureDate']));
                }else{
                    $departureDate = '';
                }
                ...
                if($timeData['arrivalDate']!='' && $timeData['arrivalDate']!='00-00-00'){
                    $arrivalDate = date('Y-m-d',strtotime($timeData['arrivalDate']));
                }else{
                    $arrivalDate = '';
                } 
                ...
                if($serviceType['serviceType']=='flight'){
                    $flightDptDate = 'flightDptDate';
                    $flightDptTime = 'flightDptTime';
                    $flightarrDate = 'flightarrDate';
                    $flightarrTime = 'flightarrTime';
                }elseif($serviceType['serviceType']=='train'){
                    $flightDptDate = 'trainDptDate';
                    $flightDptTime = 'trainDptTime';
                    $flightarrDate = 'trainarrDate';
                    $flightarrTime = 'trainarrTime';
                }else{
                    $flightDptDate = '';
                    $flightDptTime = '';
                    $flightarrDate = '';
                ...
                <input type="hidden" name="serviceType<?php  echo $entN; ?>" value="<?php echo $type; ?>">
                    <input type="hidden" name="flightAction" id="flightAction" value="flightServices">

                    <input type="hidden" name="flightTimeId<?php echo $entN; ?>" id="flightTimeId<?php echo $entN; ?>" value="<?php echo $timeData['id']; ?>">

                    <input type="hidden" name="flightQuoteId<?php echo $entN; ?>" id="flightQuoteId<?php echo $entN; ?>" value="<?php echo $flightEData['quotId']; ?>">
                   
                    <td align="left"><input type="date" class="end_start_td" name="<?php echo $flightDptDate.$entN; ?>" id="flightDptDate<?php echo $entN; ?>" value="<?= $departureDate; ?>"></td>

                    <td align="left"><input type="text" class="end_start_td flighttimepicker2" name="<?php echo $flightDptTime.$entN; ?>" id="flightDptTime<?php echo $entN; ?>" value="<?php echo $departureTime; ?>" data-time-format="H:i" placeholder="00:00" data-step="5" data-min-time="12:00" data-max-time="11:59"  data-show-2400="true"></td>

                    <td align="left"><input type="date" class="end_start_td" name="<?php echo $flightarrDate.$entN; ?>" id="flightarrDate<?php echo $entN; ?>" value="<?= $arrivalDate; ?>"></td>

                    <td align="left"><input type="text" class="end_start_td flighttimepicker2" name="<?php echo $flightarrTime.$entN; ?>" id="flightarrTime<?php echo $entN; ?>" value="<?php echo $arrivalTime; ?>" data-time-format="H:i" placeholder="00:00" data-step="5" data-min-time="12:00" data-max-time="11:59"  data-show-2400="true"></td>
                </tr>
              <?php $entN++; } ?>
              <input type="hidden" name="flightNum" id="flightNum" value="<?php echo $entN; ?>">
            </table>
        ...
        <!-- Ferry detail table sec ended -->
            ...
            <?php
                ...
                <tr>
                        ...
                        <td bgcolor="#F3F3F3" width="15%" style="font-size: 14px;padding: 10px;">

                        
                            <strong>Ferry &nbsp;Name</strong>
                        </td>
                        <td bgcolor="#F3F3F3" width="20%" style="font-size: 14px;padding: 10px;">
                            <strong>Ferry &nbsp;Service</strong>
                        </td>
                        <td bgcolor="#F3F3F3" width="10%" style="font-size: 14px;padding: 10px;">
        ...
        <?php
                    ...
                    $ferryQuery='';   
                    $ferryQuery=GetPageRecord('*','finalQuoteCruise',' quotationId="'.$quotationData['id'].'" and manualStatus=3  order by fromDate asc '); 
                    while($finalQuoteCruise=mysqli_fetch_array($ferryQuery)){
                            
                        $ccc="";
                            $ccc=GetPageRecord('*','cruiseMaster','  id="'.$finalQuoteCruise['serviceId'].'"'); 
                        $cruiseData=mysqli_fetch_array($ccc);	
    
                        $dddd="";
                        $dddd=GetPageRecord('*','cabinTypeMaster','  id="'.$finalQuoteCruise['cabinTypeId'].'"'); 
                        $cabinname=mysqli_fetch_array($dddd);
                        
                        $eee="";
                        $eee=GetPageRecord('*','cruiseNameMaster','  id="'.$finalQuoteCruise['cruiseNameId'].'"'); 
                        $cruiseName=mysqli_fetch_array($eee);
    
                    ?>
                    <div class="restaurant-dt-s"><h3 class="heading-dt-s" style="padding: 6px 5px; background-color: #acc5ef;font-size: 16px;font-weight: 500;">Cruise</h3></div>
                    <table width="100%" border="1" borderColor="#ccc" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 14px;padding: 10px;"> <?php echo strip($cruiseData['cruiseName']); ?></td> 
                            <td style="font-size: 14px;padding: 10px;"> <?php echo strip($cruiseName['name']); ?></td> 
    
                            <td style="font-size: 14px;padding: 10px;" ><?php echo strip($cabinname['name']); ?></td> 
    
                            <td style="font-size: 14px;padding: 10px;"><?php echo date('d-m-Y',strtotime($finalQuoteCruise['departureDate']));?></td>
    
                            <td style="font-size: 14px;padding: 10px;"> <?php if($finalQuoteCruise['departureTime']!=''){ echo date('H:i',strtotime($finalQuoteCruise['departureTime'])); } ?></td> 
    
                            <td style="font-size: 14px;padding: 10px;"><?php echo strip($finalQuoteCruise['confirmationNo']); ?></td> 
        ...
        <div class="restaurant-details-sec">
            <table width="100%" border="1" bordercolor="#cecece" cellpadding="5" cellspacing="0" class="restaurant-details-tdate">
                <div class="restaurant-dt-s"><h3 class="heading-dt-s" style="padding: 6px 5px; background-color: #acc5ef;font-size: 16px;font-weight: 500;">Restaurant</h3></div>
                <tr class="trav-dt-ss1" style="background-color: #f4f4f4;">
                    <th width="20%" align="left">Name</th>
                    <th width="20%" align="left">Destination</th>
                    <th width="20%" align="left">Meal Plan</th>
        ...
        <div class="restaurant-details-sec">
            <table width="100%" border="1" bordercolor="#cecece" cellpadding="5" cellspacing="0" class="restaurant-details-tdate">
                <div class="restaurant-dt-s"><h3 class="heading-dt-s" style="padding: 6px 5px; background-color: #acc5ef;font-size: 16px;font-weight: 500;">Additional</h3></div>
                <tr class="trav-dt-ss1"   style="background-color: #f4f4f4;">
                    <th width="20%" align="left">Additional Name</th>
                    <th width="20%" align="left">Destination</th>
       ...
       <?php  
        ...
        if(mysqli_num_rows($VBRC)>0){ ?>
         ...
         <div class="visa-details-sec">
            <table width="100%" border="1" bordercolor="#cecece" cellpadding="5" cellspacing="0"  class="visa-details-tdate">
                <div class="visa-dt-s"><h3 class="heading-dt-s" style="padding: 6px 5px; background-color: #acc5ef;font-size: 16px;font-weight: 500;">Visa</h3></div>
                <tr class="trav-dt-ss1"  style="background-color: #f4f4f4;">
                    <th width="20" align="left">Name</th>
        ...
        <div class="vaservices-details-sec">
            <table width="100%" border="1" bordercolor="#cecece" cellpadding="5" cellspacing="0" class="vaservices-details-tdate">
                <div class="vaservices-dt-s"><h3 class="heading-dt-s" style="padding: 6px 5px; background-color: #acc5ef;font-size: 16px;font-weight: 500;">Value Added Services</h3></div>
                <tr class="trav-dt-ss1"  style="background-color: #f4f4f4;">
                    <th width="10%" align="left">Service&nbsp;Type</th>
                    <th width="20%" align="left">Name</th>
                    <th width="" align="left">Type</th>
                </tr>
                <?php while($valueAdded = mysqli_fetch_assoc($query)){ 
                    ...
                    ?>
                <tr>
                    <td align="left"><?php echo ucfirst($serviceTypeD['serviceType']); ?></td>
                    <td align="left"><?php echo $valueAdded['serviceName']; ?></td>
                    <td align="left"><?php echo $valueAdded['typeName']; ?></td>
                </tr>
              <?php } ?>
...
<!-- Departur info start -->
            ...
            <div ><h3 class="traveller-dt-s" style="color: black;padding: 6px 5px; background-color: #acc5ef;font-size: 16px;font-weight: 500;">Departure Information Surface</h3></div>
            <table width="100%" border="1" bordercolor="#cecece" cellpadding="10" cellspacing="0" class="tbl-tdate" style="background: #e7ebec;color: black;">
                    <tr class=""  style="background-color:none!important">
                        <th width="20" align="left">Type</th>
                        <th width="20" align="left">Vehicle Type</th>
            ...
            <!-- flight -->
            <div class="flight box1" style="background: none!important;">
            <div ><h3 class="traveller-dt-s" style="padding: 6px 5px; background-color: #acc5ef;font-size: 16px;font-weight: 500;color:black;">Departure Information Flight</h3></div>
            <table width="100%" border="1" bordercolor="#cecece" cellpadding="10" cellspacing="0" class="tbl-tdate" style="background: #e7ebec;color:black;">
                    <tr class=""  style="background-color:none!important">
                        <th width="20" align="left">Type</th>
                        <th width="20" align="left">Name</th>
            ...
            <div ><h3 class="traveller-dt-s" style="padding: 6px 5px; background-color: #acc5ef;font-size: 16px;font-weight: 500;color:black;">Departure Information Train</h3></div>
            <table width="100%" border="1" bordercolor="#cecece" cellpadding="10" cellspacing="0" class="tbl-tdate" style="background-color:#e7ebec;color:black;">
                    <tr class=""  style="background-color:none!important">
                        <th width="20" align="left">Type</th>
                        <th width="20" align="left">Name</th>
                        <th width="20" align="left">Number</th>
        ...
        <div class="paymentTableSec" >
            ...
            $payId = $scheduledData['id'];
            $schduleId = $scheduledData['scheduleId'];
        
            ?>
            Payment Information Show <input type="checkbox" id="paymentDetShow" style="display: inline-block;" value="1" <?php if($scheduledData22Pa['paymentshow']==1){ ?> checked="checked" <?php } ?> onchange="ShowPaymentInfo('<?php echo $quotationId; ?>')">
			


        </div>

        <div id="saveShowPaymentInfo" style="display:none;"></div> 
        <script type="text/javascript">
      
			function ShowPaymentInfo(quotationId) {
                if($('#paymentDetShow').is(":checked")){
                $("#paymentinfoshowhide").show();
                $("#payLine").show();
                var paymentDetShow = 1;
                }else{
                    
                $("#paymentinfoshowhide").hide();
                $("#payLine").hide();
                var paymentDetShow = 0;
                }
                $("#saveShowPaymentInfo").load('frmaction.php?action=saveShowPaymentInfo&quotationId=<?php echo $quotationId; ?>&paymentshow='+paymentDetShow);
			}
        ...
        <style>
            ...
            .paymentTableSec span{
                    margin-top: 4px;
                }
            .paymentTableSec strong{
                    margin-top: 3px;
                }
        </style>
...
<?php 
               ...
               $pendingCost = $TotalPMT-$paidPayment['paidAmount'];

                if($pendingCost<0){
                    $fullpaid='Paid';
                }else{
                    $fullpaid=$pendingCost;
                }


                // if($TotalPMT == $receivedAmount){
                //    echo  'hh66'.$pendingCostLast = $TotalPMT;
                // }else{
                //     echo $fullpaid ='paid';
                // }
            
            ?>
        <div class="paymentinfo" id="paymentinfoshowhide" <?php if($scheduledData22Pa['paymentshow']==1){ ?> style="display: block;" <?php }else{ ?> style="display: none;" <?php } ?> >
            ...
            <?php 
                ...
                // $rs1cmp=GetPageRecord('*','companySettingsMaster','id=1');
                // $cmpcountryData=mysqli_fetch_array($rs1cmp);
                // $baseCurrencyId = $cmpcountryData['baseCurrencyId'];
                // if($gettotalAMT['currencyId']==''){
                //     $CurrencyIdT = $baseCurrencyId;
                // }else{
                //     $CurrencyIdT = $gettotalAMT['currencyId'];
                // }
            ?>
            ...
            <tr>
                ...
                <?php 
                    if($finalCost==0){
                        echo getChangeCurrencyValue_New($baseCurrencyId,$quotationId,$TotalPMT);
                    }else{
                        echo $finalCost;
                    }
        ...
        <div class="vaservices-dt-s"><h3 >Notes</h3></div>
            <textarea name="dmcNotes" id="dmcNotes" style="width: 98.2%;height: 60px; padding: 5px;"><?php echo strip_tags(nl2br($cli_voucherNotes)); ?></textarea>
            <br/>
            <br/>
            <div class="vaservices-dt-s"><h3 >Remarks</h3></div>
            <textarea name="dmcRemarks" id="dmcRemarks" style="width: 98.2%;height: 60px;padding: 5px;"><?php echo strip_tags(nl2br($voucherNotes)); ?></textarea>
            <br>
            <br>
           ...
           <?php
            ...
            ?>
                ...
                <div class="vaservices-dt-s"><h3 class="heading-dt-s" style="padding: 6px 5px; background-color: #acc5ef;font-size: 16px;font-weight: 500;">
                <!-- <?php echo $emData1['emergencyHeading']; ?> -->
        ...
        <div class="tour-info-it-sec">
            <div class="titsec"><h3 class="heading-dt-s" style="text-align: center;font-size: 22px; padding: 10px;border: 2px solid #ccc;background-color: #acc5ef;">Tour Information Itinerary</h3></div>
            <br>
	...
	while($QueryDaysData=mysqli_fetch_array($QueryDaysQuery)){  
		...
		?>
		<table width="100%" border="1" cellpadding="10" cellspacing="0" bordercolor="#ccc" class="borderedTable" ><tr><td align="left" class="po_tc_cls">&nbsp;&nbsp;<?php echo date('l',strtotime($dayDate));?> <?php echo date('j M Y',strtotime($dayDate));?></td></tr></table> 
		<table  width="100%" border="0" cellpadding="20" cellspacing="0" >
			...
			<div class="serviceDesc" style="text-align: left;page-break-inside: auto;font-weight: normal;font-size: 14px;"><?php
					if(strlen($QueryDaysData['title'])>1) { 
						echo "<p style='margin-top: 10px;margin-bottom: -8px;'><strong>".urldecode(strip($QueryDaysData['title']))."</strong></p>"; 
    ...
    <!-- <div class="restaurant-dt-s"><h3 class="heading-dt-s" style="text-align: center;font-size: 17px;border:1px solid;">Tour Information Itinerary End</h3></div> -->
	<br />	
    </div>
    </div>
            ...
            <?php if($overviewText!=''){ ?> 
			        <table width="100%" border="1" cellpadding="10" cellspacing="0" bordercolor="#ccc" class="borderedTable" ><tr><td align="left" class="po_tc_cls" style="font-weight: 500 !important;background-color: #acc5ef !important;font-size: 16px !important;">&nbsp;&nbsp;OVERVIEW</td></tr></table>
	        ...
	        <?php } if($inclusion!=''){ ?>
                    <table width="100%" border="1" cellpadding="10" cellspacing="0" bordercolor="#ccc" class="borderedTable" ><tr><td align="left" class="po_tc_cls">&nbsp;&nbsp;INCLUSIONS</td></tr></table>
            ...
            <?php } if($exclusion!=''){ ?> 
                    <table width="100%" border="1" cellpadding="10" cellspacing="0" bordercolor="#ccc" class="borderedTable" ><tr><td align="left" class="po_tc_cls">&nbsp;&nbsp;EXCLUSIONS</td></tr></table>
            ...
            <?php } if($tncText!=''){ ?> 
                    <table width="100%" border="1" cellpadding="10" cellspacing="0" bordercolor="#ccc" class="borderedTable" ><tr><td align="left" class="po_tc_cls">&nbsp;&nbsp;TERMS & CONDITIONS</td></tr></table>
            ...
            <?php } if($specialText!=''){ ?> 
                    <table width="100%" border="1" cellpadding="10" cellspacing="0" bordercolor="#ccc" class="borderedTable" ><tr><td align="left" class="po_tc_cls">&nbsp;&nbsp;CANCELLATION POLICIES</td></tr></table>
    ...
    <table id="printTable" width="100%" border="1" bordercolor="#cecece" cellpadding="5" cellspacing="0">
        <tr>
            <td style="border-right: 0px solid #fff;">
                <!-- <input type="button" value="Save Changes" onclick="reloadDocument();" style="cursor: pointer;"> -->
                <input name="addnewuserbtn" type="button" class="bluembutton submitbtn" id="addnewuserbtn" value="   Save Changes   " onclick="formValidation('addDMCvouhcher','submitbtn','0');" />
                <input type="hidden" name="action" id="action" value="saveDMCVoucherChanges">
        ...
        <td width="50%" align="right" style="border-left: 0px solid #fff;"> 
			<?php 
			$dmcvoucher=trim($quotationId).'_'.trim($_REQUEST['module']); 
			?>
			<a href="showpage.crm?module=query&view=yes&id=<?php echo encode($queryId); ?>&dmcvoucher=<?php echo $dmcvoucher; ?>&quotationId=<?php echo encode($quotationId); ?>" target="_blank" style="border:1px solid #ccc;padding: 3px 20px;font-size:12px;background-color:#000;color:#FFFFFF!important;border-radius: 3px;cursor:pointer;">Send</a>&nbsp;&nbsp; 
			<input type="button" name="Submit" value="Print"  style="border:1px solid #ccc;padding: 3px 20px;font-size:12px;background-color:#000;color:#FFFFFF;border-radius: 3px;cursor:pointer;" onclick="printDiv('mailSectionArea')" class="a" />			
		</td> 
        </tr>
    ...
    <style>
            ...
            .po_tc_cls{
                ...
                background-color: #acc5ef !important;
...
// new js
        ...
        function modeselect() {
        var mode = document.getElementById("selectboxmodebox").value;
        $('.surface').hide();
        $('.flight').hide();
        $('.train').hide();
