...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><div class="headingm" style="margin-left:30px;"><span id="topheadingmain">Certificate Logo</span>
...
$rs=GetRecordList($select,_CERTIFICATE_MASTER_,$where,$limit,$page,$targetpage); 
$totalentry=$rs[1]; 
$paging=$rs[2]; 
...
?>
  <tr>
    <td align="left"><?php if($resultlists['logo']!=''){ ?><img src="packageimages/<?php echo $resultlists['logo']; ?>" width="75" height="58" /><?php } ?></td>
	...
	<td align="left"><?php if($resultlists['status']==0){ echo 'Active';}else{ echo 'Inactive';} ?></td>
  </tr> 
