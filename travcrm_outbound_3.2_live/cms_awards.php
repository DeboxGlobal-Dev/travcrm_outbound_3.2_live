...
$id=$_REQUEST['id'];
	...
	header("location:?module=cms&page=awards&alt=2");	
}
//----change status-----
if($_REQUEST['status']!=""){
	$id=$_REQUEST['id'];
...
<input name="action" id="action" type="hidden" value="cms_awards" />
<input name="module" id="module" type="hidden" value="<?php echo clean($_GET['module']); ?>" />
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
      <thead>
        <tr>
          <th align="left" class="header" >Sr. No.</th>
          <th align="left" class="header" >Award Name </th>
      ...
      <?php
        ...
        $where='where type="awards" order by category asc'; 
        $page=$_GET['page'];
        ...
        <tr>
          ...
          <td width="10%" align="left">
            <?php if($resultlists['category']=='2') { ?>  AFFILIATIONS  <?php } else { ?>AWARDS AND RECOGNITION <?php }  ?>
          </td>
        	...
        	<td width="18%" align="left"><?php if($resultlists['image1']!=''){ ?><img src="<?php echo $fullurl; ?><?php echo $resultlists['image1']; ?>" height="100" />   <?php }else{ }  ?>
          </td>
        	<td width="10%" align="center">
            <?php if($resultlists['status']==1){ ?>
              <a href="showpage.crm?module=cms&page=awards&amp;status=0&amp;id=<?php echo $resultlists['id']; ?>"> <img src="images/unlock.png" width="30" border="0" /> </a>
            <?php } else { ?>
              <a href="showpage.crm?module=cms&page=awards&amp;status=1&amp;id=<?php echo $resultlists['id']; ?>"> <img src="images/lock.png" /> </a>
            <?php } ?>
          </td>
          ...
          <td width="5%" align="center">
      	  ...
      	  <td width="9%" align="center"><a href="?module=cms&amp;page=awards&amp;id=<?php echo $resultlists['id']; ?>&amp;action=del" onclick="return cmd_del()"> 
            <img src="images/dlt.png" alt="Edit" width="30" height="32" border="0" /> </a>
          </td>
      </tr>
    	<?php $no++; } ?>
    </tbody>
