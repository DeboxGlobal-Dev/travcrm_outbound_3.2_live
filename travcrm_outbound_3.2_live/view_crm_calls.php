...
<div class="rightsectionheader"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td><?php echo strip($editresult['subject']); ?></td>
  </tr>
...
<div id="pagelisterouter" style="padding-left:0px;">
 ...
 <div class="addeditpagebox vieweditpagebox">
  ...
  <tr>
	...
	<div class="gridtext" style="text-transform:uppercase;"><?php echo date('d-m-Y',strtotime($editresult['followupdate'])); ?></div>
	 
	</label>
	</div>
	
 
	 <div class="griddiv"><label><div class="gridlable">Call Type</div>
