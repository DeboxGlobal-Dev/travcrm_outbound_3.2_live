    ...
    <td width="91%" align="left" valign="top">
      ...
      <form id="listform" name="listform" method="get">
                ...
                <div class="headingm" style="margin-left:10px;"><span id="topheadingmain"><?php echo $pageName; ?></span>
                  ...
                  <div id="deactivatebtn" style="display:none;">
                    ...
                    <?php if ($deletepermission == 1) { ?>
                      ...
                      <input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Deactivate" onclick="masters_alertspopupopen('action=mastersdelete&name=RoomMaster','600px','auto');" />
              ...
              <td align="right" style="padding-right: 30px;">
                <table border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td>
                      <select name="status" id="status1" value="status" class="fa fa-angle-down bluembutton <?php if ($_REQUEST['status']) { ?> selected <?php } ?>" style="background-color:#fff!important;color:#000!important; font-size: 15px;">
        ...
        <div id="pagelisterouter" style="padding-left:30px;">
          ...
          <input name="action" id="action" type="hidden" value="deleteroomMaster" />
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-striped table-bordered" id="mainsectiontable">
            ...
            <thead>
              <tr>
                <th width="4%" class="header" align="left">Sr.</th>

                <th width="6%" height="28" align="center" valign="middle" class="header"><?php if ($editpermission == 1) { ?> <input type="checkbox" id="checkAll" name="checkedAll" onclick="checkallbox();" /><?php } ?>
                  <label for="checkAll"><span></span>&nbsp;</label>

                </th>

                <th width="80%" align="left" class="header">Room Name </th>
                <th width="10%" align="left" class="header">Room Status </th>
            ...
            <tbody>
              ...
              $rs = GetRecordList($select,'roomMaster', $where, $limit, $page, $targetpage);
              $totalentry = $rs[1];
              ...
              ?>
                <tr>
                  ...
                  <td width="2%" align="left"><?php echo $no; ?></td>
                  ...
                  <td width="80%" align="left">
                    <div class="bluelink" style="font-size:14px;"><?php echo $resultlists['name']; ?></div>
                  </td>
