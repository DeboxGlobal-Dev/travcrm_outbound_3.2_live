...
if($_REQUEST['status']!=""){
	...
	header("location:?module=cms&page=otheroffices&alt=2");
}
			...
			<td width="91%" align="left" valign="top">
				<form id="listform" name="listform" method="get">
								...
								<td align="right">
									<table border="0" cellpadding="0" cellspacing="0">
										<tr>
											...
											<?php } ?>
											<td style="padding-right:20px;"><a href="showpage.crm?module=cms&page=other_offices"><input name="addnewuserbtn" type="button" class="bluembutton" id="addnewuserbtn" value="+ Add <?php echo $pageName; ?>"></a></td>
										</tr>
									</table>
								</td>
							</tr>
					...
					<div id="pagelisterouter" style="padding-left:30px;">
						<input name="action" id="action" type="hidden" value="other_offices" />
						<input name="module" id="module" type="hidden" value="<?php echo clean($_GET['module']); ?>" />
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablesorter gridtable">
							<thead>
								<tr>
									<th  align="left" class="header" >sr. No</th>
									<th  align="left" class="header" >Contact Number</th>
									<th  align="left" class="header" >Email Address</th>
									<th  align="left" class="header" >Office Address</th>
							...
							<tbody>
								...
								$where='where type="other_offices" order by srn asc';
								$page=$_GET['page'];
								...
								?>
								<tr>
									<td width="6%" align="left"><span class="graylist"><?php echo $resultlists['srn'];?> </span></td>
									<td width="15%" align="left"><span class="graylist"><?php echo $resultlists['title'];?> </span></td>
									<td width="15%" align="left"><span class="graylist"><?php echo $resultlists['email'];?> </span></td>
									...
									<td width="5%" align="center">
										<?php if($resultlists['status']==1){ ?>
											<a href="showpage.crm?module=cms&page=otheroffices&status=0&id=<?php echo $resultlists['id']; ?>">
											<img src="images/unlock.png" width="25" border="0" />		            
										</a>
										<?php } else { ?>
											<a href="showpage.crm?module=cms&page=otheroffices&status=1&id=<?php echo $resultlists['id']; ?>">
											<img src="images/lock.png" />		            
										</a>
										<?php } ?>	
									</td>
									<td width="5%" align="center">
										<a href="?module=cms&page=otheroffices&amp;id=<?php echo $resultlists['id']; ?>&amp;action=del" onclick="return cmd_del()"> 
											<img src="images/dlt.png" alt="Edit" width="25" border="0" /> 
										</a>
									</td>
									<td width="5%" align="center">
										<a href="showpage.crm?module=cms&page=other_offices&id=<?php echo $resultlists['id']; ?>">
