  ...
  <tr>
    ...
    <td align="right"><table border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <?php if($addpermission==1){ ?><td style="padding-right:20px;"><input name="addnewuserbtn" type="button" class="bluembutton" id="addnewuserbtn" value="+ Add New <?php echo $pageName; ?>" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&sectiontype=<?php echo clean($_GET['module']); ?>','600px','auto');" /></td> <?php } ?>
      </tr>
...
$where='where name!="" and fileType=2 and deletestatus=0 order by id desc';
$page=$_GET['page'];
...
?>
  <tr>
    ...
    <td width="11%" align="left"><div class="bluelink" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&sectiontype=<?php echo clean($_GET['module']); ?>&id=<?php echo $resultlists['id']; ?>','600px','auto');" ><?php echo $resultlists['name']; ?></div>   </td>
...
<td width="" align="left"><?php if($resultlists['fileType'] == '1'){ echo "Company File";}elseif($resultlists['fileType'] == '2'){ echo "HR File";}elseif($resultlists['fileType'] == '3'){ echo "Employee File";}else{ echo "File Report";} ?></td>
	...
	<td align="left" ><a href="showpage.crm?module=hrmshrfile&view=yes&id=<?php echo encode($resultlists['id']); ?>"><input name="addnewuserbtn" type="button" class="bluembutton" value="View"/></a></td>
	</tr> 
