    ...
    <td width="91%" align="left" valign="top">
      ...
      <form id="listform" name="listform" method="get">
                ...
                <div class="headingm" style="margin-left:10px;"><span id="topheadingmain"><?php echo $pageName; ?></span>
                  ...
                  <div id="deactivatebtn" style="display:none;">
                    ...
                    <?php if ($deletepermission == 1) { ?>
                      ...
                      <input name="deactivate" type="button" class="redmbutton" id="deactivate" value="Deactivate" onclick="masters_alertspopupopen('action=mastersdelete&name=cruiseName','600px','auto');" />
              ...
              <td align="right">
                <table border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <?php if ($addpermission == 1) { ?><td style="padding-right:20px;"><input name="addnewuserbtn" type="button" class="bluembutton" id="addnewuserbtn" value="+ Add <?php echo "Cruise Name"; ?>" onclick="masters_alertspopupopen('action=addedit_<?php echo clean($_GET['module']); ?>&sectiontype=<?php echo clean($_GET['module']); ?>','400px','auto');" /></td> <?php } ?>
        ...
        <div id="pagelisterouter" style="padding-left:30px;">
          ...
          <input name="action" id="action" type="hidden" value="deleteCruiseName" />
          ...
          <table width="100%" border="1" cellpadding="0" cellspacing="0" class="table table-striped table-bordered" id="mainsectiontable">
            ...
            <tbody>
              ...
              $rs = GetRecordList($select,'cruiseNameMaster', $where, $limit, $page, $targetpage);
                ...
                <tr>
                  ...
                  <td align="left" width="5%"><?php if($resultlists['image']!=''){ ?><img src="packageimages/<?php echo $resultlists['image']; ?>" width="75" height="58" /><?php }else{ echo "<img src='".$fullurl."images/hotelthumbpackage.png' width='75' height='58'>"; } ?></td>
                    ...
                    // echo $resultlists['ferryCompanyId'];
                     $getferyc = GetPageRecord('*','cruiseCompanyMaster',' id="'.$resultlists['cruiseCompanyId'].'" and deletestatus=0 and status=1');
